...
create table acs_mail_lite_from_external (
       aml_email_id         integer DEFAULT acs_mail_lite_id_seq.nextval
...
create table acs_mail_lite_ui (
       ...
       reject_on_hit varchar(4000),
       reject_on_miss varchar(4000)
);
...
create table acs_mail_lite_send_msg_id_map (
       ...
       -- unique not null
       msg_id        varchar(4000) primary key,
       package_id    integer
