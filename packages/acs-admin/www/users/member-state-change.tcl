...
switch $email_verified_p {
	...
	set pl_sql "acs_user.approve_email ( user_id => :user_id );"
	...
	set pl_sql "acs_user.unapprove_email ( user_id => :user_id );"
...
if [catch {db_exec_plsql update_user_state "
begin
$pl_sql
end;"} errmsg] {
