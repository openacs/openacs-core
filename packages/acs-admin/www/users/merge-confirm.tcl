ad_page_contract {
    ...
    if_diff_authority {        
        set from_authority_id [acs_user::get_element -user_id $from_user_id -element authority_id]
        set to_authority_id [acs_user::get_element -user_id $to_user_id -element authority_id]
