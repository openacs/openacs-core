...
extra complexity of nesting several templates.</p>
...
<p>That last phase is ended by <b>Done invoking trace filter
ds_trace_filter (returning filter_ok)</b>
</p>
<h4>Total time</h4>
<img src="time1/stage14.gif">
<p>Overall, the templated pages are delivered <b>faster</b>.
...
they are still faster than the Tcl-only page.</p>
<hr>
