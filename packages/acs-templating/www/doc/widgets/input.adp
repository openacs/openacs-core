...
described in the general widgets <a href="../index.html">reference</a>. The value of this widget is the text
string.</p><h3>The Radio Group Widget</h3><p>This widget actually represents a group of radio buttons, at
...
label-value pairs. For example,</p><blockquote><pre>
...
value of <code>cost</code> will be <code>50000</code>.
...
used.</p><h3>The Checkbox Group Widget</h3><p>This widget is identical in use to the Radio Group widget, but
...
(singular) property contains the first element in the list.</p><hr><a href="mailto:templating\@arsdigita.com">templating\@arsdigita.com</a>
</body>
