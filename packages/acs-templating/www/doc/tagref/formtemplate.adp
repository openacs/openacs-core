...
template:</p><pre>&lt;formtemplate id="add_user" style="standard"&gt;&lt;/formtemplate&gt;</pre><p>The <kbd>style</kbd> attribute is optional. It may be used to
...
discourage the use of inline Javascript event handlers.</p><pre>&lt;formtemplate id="add_user" style="background-color:white;"&gt;</pre><p>This will work for both autogenerated and explicitly formatted
forms.</p>
