  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --
    --  $HeadURL: http://svn.xinha.python-hosting.com/trunk/XinhaConfig.js $
    --  $LastChangedDate: 2007-04-12 09:23:45 +1200 (Thu, 12 Apr 2007) $
...
{
  'Release'   : 'Trunk',
  'Head'      : '$HeadURL: http://svn.xinha.python-hosting.com/trunk/XinhaConfig.js $'.replace(/^[^:]*: (.*) \$$/, '$1'),
  'Date'      : '$LastChangedDate: 2007-04-12 09:23:45 +1200 (Thu, 12 Apr 2007) $'.replace(/^[^:]*: ([0-9-]*) ([0-9:]*) ([+0-9]*) \((.*)\) \$/, '$4 $2 $3'),
  'Revision'  : '$LastChangedRevision: 811 $'.replace(/^[^:]*: (.*) \$$/, '$1'),
