        ...
        <th class="@elements.class@"@elements.cell_attributes;noquote@>
          <if @elements.orderby_url@ not nil>
            <if @elements.ordering_p@ true>
              ...
              <a href="@elements.orderby_url@" title="@elements.orderby_html_title@"><if @elements.orderby_direction@ eq "desc"><img src="/resources/acs-templating/sort-descending.png" alt="" border="0" /></if><else><img src="/resources/acs-templating/sort-ascending.png" alt="" border="0"/></else></a>
            </if>
            <else>
              <a href="@elements.orderby_url@" title="@elements.orderby_html_title@">@elements.label;noquote@</a> <img src="/resources/acs-templating/sort-neither.png" alt="" border="0" />
            </else>
          </if>
          <else>
