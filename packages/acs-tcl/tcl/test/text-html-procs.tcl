...
">
    ...
    #
    # Replicate some notorious XSS attempts by penetration tools
    #

    set cases [list]

    lappend cases \
        {Disguising the colon ":" character} \
...
aa_register_case \
    ...
    util_expand_entities {
        ...
        foreach {input expected} {
            ...
            {A text with &amp entity without semicolon}
            {A text with &amp entity without semicolon}

            {A text with markup inside: <a href="#link">Ciao</a> <span>Text</span>}
            {A text with markup inside: <a href="#link">Ciao</a> <span>Text</span>}

            {This test contains all supported entities: &lt;, &gt;, &quot;, &amp;, &mdash; and &#151;}
            {This test contains all supported entities: <, >, ", &, -- and --}

            {This test contains all supported entities without semicolon: &lt, &gt, &apmquot, &amp, &mdash and &#151}
            {This test contains all supported entities without semicolon: &lt, &gt, &apmquot, &amp, &mdash and &#151}
        } {
        ...
        foreach {input expected} {
            ...
            {This test contains various supported entities by number with extra 0s: &#0000000000060;, &#0000000000000000000000000000062;, &#034;, &#0038; and &#0008212;}
            {This test contains various supported entities by number with extra 0s: <, >, ", & and —}

            {This test contains various supported entities by hex: &#x3C;, &#x3E;, &#x22;, &#x26; and &#x2014}
            ...
            {This test contains various supported entities by hex without semicolon: &#x3C;, &#x3E;, &#x22;, &#x26; and &#x2014}
