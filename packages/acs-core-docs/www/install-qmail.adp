...
<a class="indexterm" name="idp140302495064848" id="idp140302495064848"></a> (I'm not sure if this next step is 100%
...
<p>
<strong>Install Qmail. </strong><a class="indexterm" name="idp140302495274704" id="idp140302495274704"></a>
</p><p>
...
cd netqmail-1.04
make setup check</span></span>
</pre><p>Replace sendmail with qmail's wrapper.</p><a class="indexterm" name="idp140302505101568" id="idp140302505101568"></a><pre class="screen">
...
</pre><a class="indexterm" name="idp140302495329200" id="idp140302495329200"></a><p>Configure qmail to use the Maildir delivery format (instead of
