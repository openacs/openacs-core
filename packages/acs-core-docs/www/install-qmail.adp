...
<a class="indexterm" name="idp140255971920520" id="idp140255971920520"></a> (I&#39;m not sure if this next step is
...
<p>
<strong>Install Qmail. </strong><a class="indexterm" name="idp140255972771016" id="idp140255972771016"></a>
</p><p>
...
cd netqmail-1.04
make setup check</span></span>
</pre><p>Replace sendmail with qmail&#39;s wrapper.</p><a class="indexterm" name="idp140255977091816" id="idp140255977091816"></a><pre class="screen">
...
</pre><a class="indexterm" name="idp140255977104904" id="idp140255977104904"></a><p>Configure qmail to use the Maildir delivery format (instead of
