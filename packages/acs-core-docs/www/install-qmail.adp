...
<p>Replace sendmail with qmail&#39;s wrapper.</p><a class="indexterm" name="idp140665014912016" id="idp140665014912016"></a><pre class="screen">[root qmail-1.03]# <strong class="userinput"><code>rm -f /usr/bin/sendmail /usr/sbin/sendmail</code></strong>
...
</pre><a class="indexterm" name="idp140665014925104" id="idp140665014925104"></a><p>Configure qmail to use the Maildir delivery format (instead of
