...
<a class="indexterm" name="idp140302503494480" id="idp140302503494480"></a> (I'm not sure if this next step is 100%
...
<p>
<b>Install Qmail. </b><a class="indexterm" name="idp140302503500944" id="idp140302503500944"></a>
</p><p>
...
cd netqmail-1.04
make setup check</span></span>
</pre><p>Replace sendmail with qmail's wrapper.</p><a class="indexterm" name="idp140302503517152" id="idp140302503517152"></a><pre class="screen">
...
</pre><a class="indexterm" name="idp140302503530240" id="idp140302503530240"></a><p>Configure qmail to use the Maildir delivery format (instead of
