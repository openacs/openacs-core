...
<a class="indexterm" name="idp140216767871888" id="idp140216767871888"></a> (I'm not sure if this next step is 100%
...
<p>
<b>Install Qmail. </b><a class="indexterm" name="idp140216767878352" id="idp140216767878352"></a>
</p><p>
...
cd netqmail-1.04
make setup check</span></span>
</pre><p>Replace sendmail with qmail's wrapper.</p><a class="indexterm" name="idp140216767894560" id="idp140216767894560"></a><pre class="screen">
...
</pre><a class="indexterm" name="idp140216765798160" id="idp140216765798160"></a><p>Configure qmail to use the Maildir delivery format (instead of
