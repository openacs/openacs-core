...
<a class="indexterm" name="idp140480052150944" id="idp140480052150944"></a> (I'm not sure if this next step is 100%
...
<p>
<b>Install Qmail. </b><a class="indexterm" name="idp140480052413744" id="idp140480052413744"></a>
</p><p>
...
cd netqmail-1.04
make setup check</span></span>
</pre><p>Replace sendmail with qmail's wrapper.</p><a class="indexterm" name="idp140480064926560" id="idp140480064926560"></a><pre class="screen">
...
</pre><a class="indexterm" name="idp140480052269712" id="idp140480052269712"></a><p>Configure qmail to use the Maildir delivery format (instead of
