...
<a name="idp140697732723312" id="idp140697732723312"></a><p class="title"><strong>Figure 11.1. Server file layout
...
<a name="idp140697732391776" id="idp140697732391776"></a><p class="title"><strong>Figure 11.2. Package file layout
diagram</strong></p><div class="figure-contents"><pre class="programlisting">
ROOT/
  +-- packages/    APM Root
        |
...
<a name="idp140697732397568" id="idp140697732397568"></a><p class="title"><strong>Table 11.1. Package
