...
<a name="idp140186666197944" id="idp140186666197944"></a><p class="title"><strong>Figure 11.1. Server file layout
...
<a name="idp140186670176808" id="idp140186670176808"></a><p class="title"><strong>Figure 11.2. Package file layout
diagram</strong></p><div class="figure-contents"><pre class="programlisting">
ROOT/
  +-- packages/    APM Root
        |
...
<a name="idp140186685512456" id="idp140186685512456"></a><p class="title"><strong>Table 11.1. Package
...
tutorial</a></p></li>
</ul></div><div class="cvstag">($&zwnj;Id: packages.xml,v 1.9.14.3 2017/04/21
