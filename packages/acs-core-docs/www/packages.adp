...
<a name="idp140183975339608" id="idp140183975339608"></a><p class="title"><strong>Figure 11.1. Server file layout
...
<a name="idp140183975346328" id="idp140183975346328"></a><p class="title"><strong>Figure 11.2. Package file layout
diagram</strong></p><div class="figure-contents"><pre class="programlisting">
ROOT/
  +-- packages/    APM Root
        |
...
<a name="idp140183975351432" id="idp140183975351432"></a><p class="title"><strong>Table 11.1. Package
