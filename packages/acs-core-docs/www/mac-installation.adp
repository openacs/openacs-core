...
<property name="context">{/doc/acs-core-docs {ACS Core Documentation}} {OpenACS Installation Guide for Mac OS X}</property>
...
</p><div class="cvstag">($&zwnj;Id: mac-installation.html,v 1.42.2.12
