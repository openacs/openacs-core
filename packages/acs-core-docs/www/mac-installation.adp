...
<property name="context">{/doc/acs-core-docs {Documentation}} {OpenACS Installation Guide for Mac OS X}</property>
...
</p><div class="cvstag">($&zwnj;Id: macinstall.xml,v 1.7 2014/10/27 16:39:31
victorg Exp $)</div>
</div>
