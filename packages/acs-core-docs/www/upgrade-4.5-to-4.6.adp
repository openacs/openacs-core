...
<a name="upgrade-4.5-to-4.6" id="upgrade-4.5-to-4.6"></a>Upgrading 4.5 or higher to 4.6.3</h2></div></div></div><a class="indexterm" name="idp140560457549416" id="idp140560457549416"></a><p>The required platform for OpenACS 4.6 is the same as 4.5, with
