...
<property name="context">{/doc/acs-core-docs {Documentation}} {Object Identity}</property>
...
more than one way to represent identity.</p><p>So, this apparently redundant primary key has saved us the
...
even capable of fully tracking the history of membership state.</p><p>The design choice of explicitly representing object identity
