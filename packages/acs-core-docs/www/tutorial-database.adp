...
<a name="idp140480051652128" id="idp140480051652128"></a>Code the data model</h3></div></div></div><p>We create all database objects with scripts in the <code class="computeroutput">myfirstpackage/sql/</code> directory. All database
...
<a name="idp140480044866256" id="idp140480044866256"></a><p class="title"><b>Figure 9.2. Tutorial
...
<a name="idp140480058839488" id="idp140480058839488"></a><p class="title"><b>Figure 9.3. The
...
<a name="idp140480054718224" id="idp140480054718224"></a><p class="title"><b>Figure 9.4. Database
