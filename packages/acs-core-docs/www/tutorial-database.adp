...
<property name="context">{/doc/acs-core-docs {Documentation}} {Setting Up Database Objects}</property>
...
<a name="idp140399715852448" id="idp140399715852448"></a>Code the data model</h3></div></div></div><p>We create all database objects with scripts in the <code class="computeroutput">myfirstpackage/sql/</code> directory. All database
...
<a name="idp140399715867904" id="idp140399715867904"></a><p class="title"><strong>Figure 9.2. Tutorial
...
<a name="idp140399745165648" id="idp140399745165648"></a><p class="title"><strong>Figure 9.3. The
...
<a name="idp140399745392352" id="idp140399745392352"></a><p class="title"><strong>Figure 9.4. Database
