...
<a name="idp140698007115040" id="idp140698007115040"></a>Code the data model</h3></div></div></div><p>We create all database objects with scripts in the <code class="computeroutput">myfirstpackage/sql/</code> directory. All database
...
<a name="idp140698002449680" id="idp140698002449680"></a><p class="title"><strong>Figure 9.2. Tutorial Data
...
<a name="idp140698006946784" id="idp140698006946784"></a><p class="title"><strong>Figure 9.3. The Database
...
<a name="idp140698007213488" id="idp140698007213488"></a><p class="title"><strong>Figure 9.4. Database Deletion
