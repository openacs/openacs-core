...
<a name="idp140434643966184" id="idp140434643966184"></a>Code the data model</h3></div></div></div><p>We create all database objects with scripts in the <code class="computeroutput">myfirstpackage/sql/</code> directory. All database
...
<a name="idp140434643706120" id="idp140434643706120"></a><p class="title"><strong>Figure 9.2. Tutorial Data
...
<a name="idp140434643608472" id="idp140434643608472"></a><p class="title"><strong>Figure 9.3. The
...
<a name="idp140434643898088" id="idp140434643898088"></a><p class="title"><strong>Figure 9.4. Database Deletion
