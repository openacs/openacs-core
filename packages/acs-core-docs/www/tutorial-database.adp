...
<a name="idp140216757038288" id="idp140216757038288"></a>Code the data model</h3></div></div></div><p>We create all database objects with scripts in the <code class="computeroutput">myfirstpackage/sql/</code> directory. All database
...
<a name="idp140216746000736" id="idp140216746000736"></a><p class="title"><b>Figure 9.2. Tutorial
...
<a name="idp140216746001312" id="idp140216746001312"></a><p class="title"><b>Figure 9.3. The
...
<a name="idp140216759261840" id="idp140216759261840"></a><p class="title"><b>Figure 9.4. Database
