...
David Eison's ForeachFileAntTask.java, available at <a href="http://cvs.arsdigita.com/cgi-bin/cvsweb.pl/acs-java-4/WEB-INF/src/com/arsdigita/build/">
...
into the toplevel build.xml file or into a configuration file.</p>
<p>You should now be ready to run the tests. Go to your server's
"packages" directory and type <code>source ./paths.sh</code> to set
up your classpath. Now type <code>ant</code>. Ant should find the
...
which tests failed and which succeeded.</p>
