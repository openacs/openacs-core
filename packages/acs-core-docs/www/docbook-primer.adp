...
Docbook.</p><p>
<a class="indexterm" name="idp140186686619976" id="idp140186686619976"></a> is a publishing standard based on XML
...
you remember to</strong></span>: <a class="indexterm" name="idp140186686554392" id="idp140186686554392"></a>
...
<span class="emphasis"><em>emphasized</em></span>: <a class="indexterm" name="idp140186686529448" id="idp140186686529448"></a>
...
<a class="indexterm" name="idp140186686515832" id="idp140186686515832"></a> Given that your job starts at the
...
<a class="indexterm" name="idp140186686513000" id="idp140186686513000"></a> You need to feed every <code class="computeroutput">&lt;sect1&gt;</code> two attributes. The first
...
<a class="indexterm" name="idp140186686502648" id="idp140186686502648"></a> The other attribute is <code class="computeroutput">xreflabel</code>. The value of this is the text
...
<a class="indexterm" name="idp140186686506920" id="idp140186686506920"></a> Inside this container your document will
...
<a class="indexterm" name="idp140186686487112" id="idp140186686487112"></a> For displaying a snippet of code, a
...
<a class="indexterm" name="idp140186686480184" id="idp140186686480184"></a> Linking falls into two different
...
<a class="indexterm" name="idp140186686476920" id="idp140186686476920"></a>Check out how I link to a subsection of
...
<p>
<a class="indexterm" name="idp140186686458584" id="idp140186686458584"></a> If you&#39;re hyper-linking out of the
...
for you.</em></span></p><p>
<a class="indexterm" name="idp140186686446664" id="idp140186686446664"></a> To insert a graphic we use the elements
...
<a class="indexterm" name="idp140186686439560" id="idp140186686439560"></a> Here&#39;s how you make the DocBook
...
<a class="indexterm" name="idp140186686414648" id="idp140186686414648"></a> DocBook supports several types of tables,
...
<a class="indexterm" name="idp140186686400024" id="idp140186686400024"></a> Our documentation uses two flavors of
...
elements and their "look" in HTML and lots of good links
for tools.</p></li><li class="listitem"><p>James Clark wrote <a class="link" href="nxml-mode" title="Using nXML mode in Emacs">nXML Mode</a>, an alternative to PSGML
