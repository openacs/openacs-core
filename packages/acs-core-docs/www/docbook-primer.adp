...
Docbook.</p><p>
<a class="indexterm" name="idp140302511974176" id="idp140302511974176"></a> is a publishing standard based on XML
...
you remember to</strong></span>: <a class="indexterm" name="idp140302499799616" id="idp140302499799616"></a>
...
that is structured like this - examples are <span class="emphasis"><em>emphasized</em></span>: <a class="indexterm" name="idp140302503391136" id="idp140302503391136"></a>
...
<a class="indexterm" name="idp140302500870048" id="idp140302500870048"></a> Given that your job starts at the
...
<a class="indexterm" name="idp140302502838688" id="idp140302502838688"></a> You need to feed every <code class="computeroutput">&lt;sect1&gt;</code> two attributes. The first
...
<a class="indexterm" name="idp140302502661632" id="idp140302502661632"></a> The other attribute is <code class="computeroutput">xreflabel</code>. The value of this is the text
...
<a class="indexterm" name="idp140302501845136" id="idp140302501845136"></a> Inside this container your document will
...
<a class="indexterm" name="idp140302506149584" id="idp140302506149584"></a> For displaying a snippet of code, a
...
<a class="indexterm" name="idp140302500513408" id="idp140302500513408"></a> Linking falls into two different
...
<a class="indexterm" name="idp140302499771504" id="idp140302499771504"></a>Check out how I link to a subsection of
...
<p>
<a class="indexterm" name="idp140302500992592" id="idp140302500992592"></a> If you're hyper-linking out of the
...
for you.</em></span></p><p>
<a class="indexterm" name="idp140302501158608" id="idp140302501158608"></a> To insert a graphic we use the elements
...
<a class="indexterm" name="idp140302504776576" id="idp140302504776576"></a> Here's how you make the DocBook
...
<a class="indexterm" name="idp140302500003040" id="idp140302500003040"></a> DocBook supports several types of tables,
...
<a class="indexterm" name="idp140302506684784" id="idp140302506684784"></a> Our documentation uses two flavors of
