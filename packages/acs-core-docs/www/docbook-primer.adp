...
good documentation base from ArsDigita's ACS in the late 1990's.
Some sections of the documentation, however, lacked details and
examples; others simply did not exist. The OpenACS community began
meeting the challenge by identifying needs and writing
documentation on an as needed basis.</p><p>By having documentation dependent on volunteers and code
...
users to complete tasks or understand... for example, "Simply...".
Readers come from many different backgrounds --remember that the
greater audience is likely as varied as the readers on the
internet--- If important, state pre-conditions or knowledge
requirements etc. if different than the rest of the context of the
document. For example, "requires basic competency with a text-based
editor such as vi or emacs via telnet"</p></li>
</ul></div>
...
OpenACS (with quotes in their own words) "...the most important
thing that the ACS does is manage users, i.e. provide a way to
group, view and manipulate members of the web community. -- Talli
Somekh, September 19, 2001" using it to communicate, cooperate,
collaborate... OpenACS offers directed content functionality with
the OpenACS templating system. ... OpenACS is more than a data
collection and presentation tool. OpenACS has management facilities
that are absent in other portals. ...The beauty of OpenACS is the
simplicity (and scalability) of the platform on which it is built
and the library of tried and tested community building tools that
are waiting to be added. It seems that most portals just add
another layer of complexity to the cake. See <a class="ulink" href="http://openacs.org/bboard/q-and-a-fetch-msg.tcl?msg_id=00058H&amp;topic_id=11&amp;topic=OpenACS" target="_top">Slides on OACS features</a>...a set of slides on OACS
...
<li class="listitem"><p>differentiate "product" by highlighting features, performance
quality, conformance to standards, durability (handling of
technological obsolescence), reliability, repairability, style of
use, design (strategy in design, specifications, integrated,
well-matched systems etc).</p></li><li class="listitem"><p>differentiate "service" by highlighting software availability
(licensing and completeness from mature to early adopters or
development versions), community incident support, project
collaborative opportunities, and contractor support
...
programmer's). Example issues an end-user may have questions about:
Ticket Tracker and Ticket Tracker Lite, why would I want one of
them vs the other? And, before I specify to download and install
...
documentation requirements that have been expressed in the OpenACS
forums to 4th July 2003.</p><p>OpenACS administrators' documentation should meet the following
requirements. No significance has been given to the order
presented, topic breadth or depth here.</p><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc;">
...
components work together. "The Layered Cake view" a general network
view of system; a table showing system levels versus roles to help
with understanding how the subsystems are interconnected.</p></li><li class="listitem"><p>Provide a comprehensive description of typical administrative
...
and api browser. Link to AOLserver's config file documentation.</p></li><li class="listitem"><p>Resources on high level subjects such as web services, security
...
administration including parameters, permissions, "Hello World"
page</p></li><li class="listitem"><p>Show directory structure of a typical package, explanation of
...
master.adp, options on "user pages" , a quick introduction to the
functions and processes. info about the user variables, file
locations</p></li>
</ul></div>
</div><div class="sect2">
<div class="titlepage"><div><div><h3 class="title">
...
requirements. No significance has been given to the order
presented, topic breadth or depth here.</p><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc;">
<li class="listitem"><p>state installation prerequisites. For example: "You should read
through the installation process to familiarize yourself with the
installation process, before beginning an installation."</p></li><li class="listitem"><p>list critical decisions (perhaps as questions) that need to be
...
the installation, you will be acting on decisions that have an
impact on how the remaining part of the system is installed. Here
is a list of questions you should answer before beginning."</p></li><li class="listitem"><p>list pre-installation assumptions</p></li><li class="listitem"><p>Show chronological overview of the process of installing a
...
development, by referring to developer resources.</p></li><li class="listitem"><p>Use the ArsDigita problem sets and "what Lars produced for ACS
Java" as inspiration for a PostgreSQL equivalent tutorial about
developing a new OpenACS package including discussion of the
...
including an updated summary of Greenspun's Chapter 4: Data Models
and the Object System</p></li><li class="listitem"><p>package design guidelines and development process templates
including planning, core functions, testing, usability, and
creating case studies</p></li><li class="listitem">
<p>Standard package conventions, where to see "model" code, and
guidelines (or where to find them) for:</p><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: circle;">
...
Docbook.</p><p>
<a class="indexterm" name="idp140480085043776" id="idp140480085043776"></a> is a publishing standard based on XML
...
with a couple extra rules. More details in the <a class="ulink" href="http://en.tldp.org/LDP/LDP-Author-Guide/docbookxml.html" target="_top">LDP Author Guide</a>.</p></li><li class="listitem"><p>
...
hierarchy arguably remains DocBooks' weakest point. For example, a
dynamically built document should be able to extract details of a
specific reference from a bibliographic (table) and present a
footnote at the point where referenced. DocBook 4.4 allows for this
with <code class="computeroutput">bibliocoverage</code>,
<code class="computeroutput">bibliorelation</code>, and
<code class="computeroutput">bibliosource</code>. <a class="ulink" href="http://www.docbook.org/tdg/en/html/docbook.html" target="_top">DocBook: The Definitive Guide</a> is a good start for
...
you remember to</strong></span>: <a class="indexterm" name="idp140480085061616" id="idp140480085061616"></a>
...
nXML modes. The <a class="ulink" href="http://en.tldp.org/LDP/LDP-Author-Guide/" target="_top">LDP Author
Guide</a> and <a class="ulink" href="http://wiki.docbook.org/topic/DocBookAuthoringTools" target="_top">DocBook Wiki</a> list some alternates.</p></li>
</ul></div>
</div><div class="sect2">
<div class="titlepage"><div><div><h3 class="title">
...
the <a class="ulink" href="http://openacs.org/cvs/openacs-4/packages/acs-core-docs/www/xml/engineering-standards" target="_top">sources for acs-core-docs</a>, especially the
...
<div class="titlepage"><div><div><h3 class="title">
<a name="dbprimer-structure" id="dbprimer-structure"></a>Document Structure</h3></div></div></div><p>The documentation for each package will make up a little "book"
that is structured like this - examples are <span class="emphasis"><em>emphasized</em></span>: <a class="indexterm" name="idp140480045453008" id="idp140480045453008"></a>
...
documenting an entire package.</p><p>For now you can take a look at the <a class="ulink" href="http://openacs.org/cvs/openacs-4/packages/acs-core-docs/www/xml/engineering-standards" target="_top">sources of these DocBook documents</a> to get an idea
of how they are tied together.</p>
</div><div class="sect2">
<div class="titlepage"><div><div><h3 class="title">
<a name="dbprimer-sections" id="dbprimer-sections"></a>Headlines, Sections</h3></div></div></div><p>
<a class="indexterm" name="idp140480054900176" id="idp140480054900176"></a> Given that your job starts at the
...
<a class="indexterm" name="idp140480058068848" id="idp140480058068848"></a> You need to feed every <code class="computeroutput">&lt;sect1&gt;</code> two attributes. The first
...
<a class="indexterm" name="idp140480084895520" id="idp140480084895520"></a> The other attribute is <code class="computeroutput">xreflabel</code>. The value of this is the text
...
<a class="indexterm" name="idp140480060905040" id="idp140480060905040"></a> Inside this container your document will
...
sections, but it makes linking to that section a lot easier.</p><p>When it comes to naming your <code class="computeroutput">sect2</code>'s and below, prefix them with some
abbreviation of the <code class="computeroutput">id</code> in the
<code class="computeroutput">sect1</code> such as <code class="computeroutput">requirements-overview</code>.</p>
</div><div class="sect2">
<div class="titlepage"><div><div><h3 class="title">
<a name="dbprimer-code" id="dbprimer-code"></a>Code</h3></div></div></div><p>
<a class="indexterm" name="idp140480060770176" id="idp140480060770176"></a> For displaying a snippet of code, a
...
<a class="indexterm" name="idp140480059673376" id="idp140480059673376"></a> Linking falls into two different
...
<p>By having unique <code class="computeroutput">id</code>'s you
can cross-reference any part of your book with a simple tag,
regardless of where that part is.</p><p>
<a class="indexterm" name="idp140480045150144" id="idp140480045150144"></a>Check out how I link to a subsection of
...
<li class="listitem"><p>Provide the end-tag, <code class="computeroutput">&lt;/xref&gt;</code>, or</p></li><li class="listitem"><p>Put a slash before the ending-bracket: <code class="computeroutput">&lt;xref linkend="blahblah"/&gt;</code>
</p></li>
...
<p>
<a class="indexterm" name="idp140480085322384" id="idp140480085322384"></a> If you're hyper-linking out of the
...
for you.</em></span></p><p>
<a class="indexterm" name="idp140480058348576" id="idp140480058348576"></a> To insert a graphic we use the elements
...
&lt;mediaobject&gt;
  ...
  &lt;/textobject&gt;
&lt;/mediaobject&gt;
</pre><p>Put your graphics in a separate directory ("images") and link to
them only with relative paths.</p>
</div><div class="sect2">
<div class="titlepage"><div><div><h3 class="title">
<a name="dbprimer-lists" id="dbprimer-lists"></a>Lists</h3></div></div></div><p>
<a class="indexterm" name="idp140480060257184" id="idp140480060257184"></a> Here's how you make the DocBook
...
<a class="indexterm" name="idp140480060108688" id="idp140480060108688"></a> DocBook supports several types of tables,
...
will be a simple HTML-table:</p><div class="informaltable"><table cellspacing="0" border="1">
<colgroup>
<col><col><col>
</colgroup><tbody>
<tr>
...
<a class="indexterm" name="idp140480059594864" id="idp140480059594864"></a> Our documentation uses two flavors of
...
defaults to italics when parsed. If you're looking for emphasizing
with bold type, use <code class="computeroutput">&lt;emphasis
role="strong"&gt;</code>.</p>
</div><div class="sect2">
<div class="titlepage"><div><div><h3 class="title">
...
</pre><p>You could also look at the <a class="ulink" href="http://cvs.openacs.org/cvs/openacs-4/packages/acs-core-docs/www/xml/Makefile?view=markup" target="_top">acs-core-docs Makefile</a> for examples of how these
...
<li class="listitem"><p><a class="ulink" href="http://www.xml.com/lpt/a/2002/07/31/xinclude.html" target="_top">Using Xinclude</a></p></li><li class="listitem"><p>The <a class="ulink" href="http://en.tldp.org/LDP/LDP-Author-Guide/" target="_top">LDP Author
Guide</a> has a lot of good information, a table of docbook
elements and their "look" in HTML and lots of good links for
tools.</p></li><li class="listitem"><p>James Clark wrote <a class="link" href="nxml-mode" title="Using nXML mode in Emacs">nXML Mode</a>, an alternative to PSGML
...
tidy</a> can be a handy tool to make your HTML "regexp'able".
Brandoch Calef has made a <a class="ulink" href="http://web.archive.org/web/20010830084757/http://developer.arsdigita.com/working-papers/bcalef/html-to-docbook.html" target="_top">Perl script with directions</a> (now via archive.org)
