...
Docbook.</p><p>
<a class="indexterm" name="idp140302487766480" id="idp140302487766480"></a> is a publishing standard based on XML
...
you remember to</strong></span>: <a class="indexterm" name="idp140302487752016" id="idp140302487752016"></a>
...
that is structured like this - examples are <span class="emphasis"><em>emphasized</em></span>: <a class="indexterm" name="idp140302487727648" id="idp140302487727648"></a>
...
<a class="indexterm" name="idp140302487717088" id="idp140302487717088"></a> Given that your job starts at the
...
<a class="indexterm" name="idp140302487712384" id="idp140302487712384"></a> You need to feed every <code class="computeroutput">&lt;sect1&gt;</code> two attributes. The first
...
<a class="indexterm" name="idp140302487706928" id="idp140302487706928"></a> The other attribute is <code class="computeroutput">xreflabel</code>. The value of this is the text
...
<a class="indexterm" name="idp140302487700560" id="idp140302487700560"></a> Inside this container your document will
...
<a class="indexterm" name="idp140302487694480" id="idp140302487694480"></a> For displaying a snippet of code, a
...
<a class="indexterm" name="idp140302487685920" id="idp140302487685920"></a> Linking falls into two different
...
<a class="indexterm" name="idp140302487669760" id="idp140302487669760"></a>Check out how I link to a subsection of
...
<p>
<a class="indexterm" name="idp140302487661984" id="idp140302487661984"></a> If you're hyper-linking out of the
...
for you.</em></span></p><p>
<a class="indexterm" name="idp140302487647872" id="idp140302487647872"></a> To insert a graphic we use the elements
...
<a class="indexterm" name="idp140302487640688" id="idp140302487640688"></a> Here's how you make the DocBook
...
<a class="indexterm" name="idp140302487617776" id="idp140302487617776"></a> DocBook supports several types of tables,
...
<a class="indexterm" name="idp140302487601040" id="idp140302487601040"></a> Our documentation uses two flavors of
