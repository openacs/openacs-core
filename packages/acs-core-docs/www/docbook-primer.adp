...
Docbook.</p><p>
<a class="indexterm" name="idp140507700243464" id="idp140507700243464"></a> is a publishing standard based on XML
...
you remember to</strong></span>: <a class="indexterm" name="idp140507700531368" id="idp140507700531368"></a>
...
<span class="emphasis"><em>emphasized</em></span>: <a class="indexterm" name="idp140507676757816" id="idp140507676757816"></a>
...
<a class="indexterm" name="idp140507698425016" id="idp140507698425016"></a> Given that your job starts at the
...
<a class="indexterm" name="idp140507698428088" id="idp140507698428088"></a> You need to feed every <code class="computeroutput">&lt;sect1&gt;</code> two attributes. The first
...
<a class="indexterm" name="idp140507668499016" id="idp140507668499016"></a> The other attribute is <code class="computeroutput">xreflabel</code>. The value of this is the text
...
<a class="indexterm" name="idp140507672652952" id="idp140507672652952"></a> Inside this container your document will
...
<a class="indexterm" name="idp140507677202184" id="idp140507677202184"></a> For displaying a snippet of code, a
...
<a class="indexterm" name="idp140507668457048" id="idp140507668457048"></a> Linking falls into two different
...
<a class="indexterm" name="idp140507699854264" id="idp140507699854264"></a>Check out how I link to a subsection of
...
<p>
<a class="indexterm" name="idp140507676991448" id="idp140507676991448"></a> If you&#39;re hyper-linking out of the
...
for you.</em></span></p><p>
<a class="indexterm" name="idp140507670022008" id="idp140507670022008"></a> To insert a graphic we use the elements
...
<a class="indexterm" name="idp140507699966648" id="idp140507699966648"></a> Here&#39;s how you make the DocBook
...
<a class="indexterm" name="idp140507670350728" id="idp140507670350728"></a> DocBook supports several types of tables,
...
<a class="indexterm" name="idp140507668869624" id="idp140507668869624"></a> Our documentation uses two flavors of
