...
Docbook.</p><p>
<a class="indexterm" name="idp140665822014416" id="idp140665822014416"></a> is a publishing standard based on XML
...
you remember to</strong></span>: <a class="indexterm" name="idp140665975637728" id="idp140665975637728"></a>
...
<span class="emphasis"><em>emphasized</em></span>: <a class="indexterm" name="idp140665974966240" id="idp140665974966240"></a>
...
<a class="indexterm" name="idp140665823877280" id="idp140665823877280"></a> Given that your job starts at the
...
<a class="indexterm" name="idp140665823075360" id="idp140665823075360"></a> You need to feed every <code class="computeroutput">&lt;sect1&gt;</code> two attributes. The first
...
<a class="indexterm" name="idp140665822752272" id="idp140665822752272"></a> The other attribute is <code class="computeroutput">xreflabel</code>. The value of this is the text
...
<a class="indexterm" name="idp140665974349840" id="idp140665974349840"></a> Inside this container your document will
...
<a class="indexterm" name="idp140665973829792" id="idp140665973829792"></a> For displaying a snippet of code, a
...
<a class="indexterm" name="idp140665013477248" id="idp140665013477248"></a> Linking falls into two different
...
<a class="indexterm" name="idp140665824170144" id="idp140665824170144"></a>Check out how I link to a subsection of
...
<p>
<a class="indexterm" name="idp140665822702832" id="idp140665822702832"></a> If you&#39;re hyper-linking out of the
...
for you.</em></span></p><p>
<a class="indexterm" name="idp140665013210416" id="idp140665013210416"></a> To insert a graphic we use the elements
...
<a class="indexterm" name="idp140665822475824" id="idp140665822475824"></a> Here&#39;s how you make the DocBook
...
<a class="indexterm" name="idp140665822018848" id="idp140665822018848"></a> DocBook supports several types of tables,
...
<a class="indexterm" name="idp140665975427056" id="idp140665975427056"></a> Our documentation uses two flavors of
