...
Docbook.</p><p>
<a class="indexterm" name="idp140697733797888" id="idp140697733797888"></a> is a publishing standard based on XML
...
you remember to</strong></span>: <a class="indexterm" name="idp140697734146944" id="idp140697734146944"></a>
...
<span class="emphasis"><em>emphasized</em></span>: <a class="indexterm" name="idp140697733808672" id="idp140697733808672"></a>
...
<a class="indexterm" name="idp140697734129104" id="idp140697734129104"></a> Given that your job starts at the
...
<a class="indexterm" name="idp140697733816128" id="idp140697733816128"></a> You need to feed every <code class="computeroutput">&lt;sect1&gt;</code> two attributes. The first
...
<a class="indexterm" name="idp140697733366080" id="idp140697733366080"></a> The other attribute is <code class="computeroutput">xreflabel</code>. The value of this is the text
...
<a class="indexterm" name="idp140697733370448" id="idp140697733370448"></a> Inside this container your document will
...
<a class="indexterm" name="idp140697733314448" id="idp140697733314448"></a> For displaying a snippet of code, a
...
<a class="indexterm" name="idp140697733358768" id="idp140697733358768"></a> Linking falls into two different
...
<a class="indexterm" name="idp140697733362368" id="idp140697733362368"></a>Check out how I link to a subsection of
...
<p>
<a class="indexterm" name="idp140697733436384" id="idp140697733436384"></a> If you&#39;re hyper-linking out of the
documentation, it works almost the same way as HTML - the tag is
just a little different (<a class="ulink" href="http://docbook.org/tdg/en/html/ulink.html" target="_top"><code class="computeroutput">&lt;ulink&gt;</code></a>):</p><pre class="programlisting">&lt;ulink url="http://www.oracle.com/"&gt;Oracle Corporation&lt;/ulink&gt;</pre><p>....will create a hyper-link to Oracle in the HTML-version of
...
for you.</em></span></p><p>
<a class="indexterm" name="idp140697734233808" id="idp140697734233808"></a> To insert a graphic we use the elements
...
<a class="indexterm" name="idp140697733926048" id="idp140697733926048"></a> Here&#39;s how you make the DocBook
...
<a class="indexterm" name="idp140697734146544" id="idp140697734146544"></a> DocBook supports several types of tables,
...
<a class="indexterm" name="idp140697733277648" id="idp140697733277648"></a> Our documentation uses two flavors of
