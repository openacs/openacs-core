...
<a name="idp140198964994176" id="idp140198964994176"></a>Debugging</h3></div></div></div><p>
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140198990499552" id="idp140198990499552"></a>Manual testing</h3></div></div></div><p>Make a list of basic tests to make sure it works</p><div class="segmentedlist"><table border="0">
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140198990511360" id="idp140198990511360"></a>Write automated tests</h3></div></div></div><div class="authorblurb">
...
<a class="indexterm" name="idp140198965042864" id="idp140198965042864"></a> It seems to me that a lot of people have
...
<a name="idp140198991265104" id="idp140198991265104"></a>TCLWebtest tests</h4></div></div></div><p>API testing can only test part of our package - it doesn&#39;t
...
<div class="titlepage"><div><div><h4 class="title">
<a name="idp140198991267920" id="idp140198991267920"></a>Example</h4></div></div></div><p>Now we can add the rest of the API tests, including a test with
