...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140560460687656" id="idp140560460687656"></a>Overview</h3></div></div></div><p>To start developing new code in OpenACS, we build a new package.
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140560460676472" id="idp140560460676472"></a>Before you begin</h3></div></div></div><p>You will need:</p><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc;">
...
<a name="idp140560460814856" id="idp140560460814856"></a><p class="title"><strong>Figure 9.1. Assumptions in this
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140560460712760" id="idp140560460712760"></a>Use the APM to initialize a new
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140560461044936" id="idp140560461044936"></a>Add an Application Instance to the
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140560461035560" id="idp140560461035560"></a>Quick start</h3></div></div></div><p>The remainder of the tutorial walks you through each file one at
