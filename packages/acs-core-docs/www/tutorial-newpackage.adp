...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140507699861096" id="idp140507699861096"></a>Overview</h3></div></div></div><p>To start developing new code in OpenACS, we build a new package.
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140507699864984" id="idp140507699864984"></a>Before you begin</h3></div></div></div><p>You will need:</p><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc;">
...
<a name="idp140507699867672" id="idp140507699867672"></a><p class="title"><strong>Figure 9.1. Assumptions in this
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140507699875096" id="idp140507699875096"></a>Use the APM to initialize a new
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140507699895512" id="idp140507699895512"></a>Add an Application Instance to the
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140507699903320" id="idp140507699903320"></a>Quick start</h3></div></div></div><p>The remainder of the tutorial walks you through each file one at
