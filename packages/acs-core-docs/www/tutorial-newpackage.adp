...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140216762875760" id="idp140216762875760"></a>Overview</h3></div></div></div><p>To start developing new code in OpenACS, we build a new package.
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140216762640544" id="idp140216762640544"></a>Before you begin</h3></div></div></div><p>You will need:</p><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc;">
...
<a name="idp140216746417472" id="idp140216746417472"></a><p class="title"><b>Figure 9.1. Assumptions
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140216760056768" id="idp140216760056768"></a>Use the APM to initialize a new
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140216760047232" id="idp140216760047232"></a>Add an Application Instance to the
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140216760019536" id="idp140216760019536"></a>Quick start</h3></div></div></div><p>The remainder of the tutorial walks you through each file one at
