...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140186667980088" id="idp140186667980088"></a>Overview</h3></div></div></div><p>To start developing new code in OpenACS, we build a new package.
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140186667416424" id="idp140186667416424"></a>Before you begin</h3></div></div></div><p>You will need:</p><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc;">
...
<a name="idp140186668207160" id="idp140186668207160"></a><p class="title"><strong>Figure 9.1. Assumptions in this
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140186666851352" id="idp140186666851352"></a>Use the APM to initialize a new
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140186666808488" id="idp140186666808488"></a>Add an Application Instance to the
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140186667681240" id="idp140186667681240"></a>Quick start</h3></div></div></div><p>The remainder of the tutorial walks you through each file one at
