...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140302506269760" id="idp140302506269760"></a>Overview</h3></div></div></div><p>To start developing new code in OpenACS, we build a new package.
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140302499743152" id="idp140302499743152"></a>Before you begin</h3></div></div></div><p>You will need:</p><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc;">
...
<a name="idp140302506938064" id="idp140302506938064"></a><p class="title"><strong>Figure 9.1. Assumptions
in this section</strong></p><div class="figure-contents"><div class="informaltable"><table class="informaltable" cellspacing="0" border="1">
<colgroup>
<col><col>
</colgroup><tbody>
<tr>
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140302501287824" id="idp140302501287824"></a>Use the APM to initialize a new
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140302499593440" id="idp140302499593440"></a>Add an Application Instance to the
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140302504862592" id="idp140302504862592"></a>Quick start</h3></div></div></div><p>The remainder of the tutorial walks you through each file one at
