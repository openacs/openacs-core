...
<property name="context">{/doc/acs-core-docs {Documentation}} {Prepare the package for distribution.}</property>
...
file to /var/tmp.</p><p><a class="indexterm" name="idp140480083717248" id="idp140480083717248"></a></p><p><a class="ulink" href="http://openacs.org/forums/message-view?message_id=192919" target="_top">Package development guidelines</a></p>
</div>
