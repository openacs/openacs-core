...
<property name="context">{/doc/acs-core-docs {ACS Core Documentation}} {Prepare the package for distribution.}</property>
...
file to /var/tmp.</p><p><a class="indexterm" name="idp140667816088264" id="idp140667816088264"></a></p><p><a class="ulink" href="http://openacs.org/forums/message-view?message_id=192919" target="_top">Package development guidelines</a></p>
</div>
