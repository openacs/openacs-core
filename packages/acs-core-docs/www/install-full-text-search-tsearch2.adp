...
<a name="install-tsearch2" id="install-tsearch2"></a>Install Tsearch2 module</h3></div></div></div><a class="indexterm" name="idp140216767287024" id="idp140216767287024"></a><p>If you want full text search, and you are running PostgreSQL,
