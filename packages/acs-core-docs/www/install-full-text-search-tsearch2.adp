...
<a name="install-tsearch2" id="install-tsearch2"></a>Install Tsearch2 module</h3></div></div></div><a class="indexterm" name="idp140302505931888" id="idp140302505931888"></a><p>If you want full text search, and you are running PostgreSQL,
