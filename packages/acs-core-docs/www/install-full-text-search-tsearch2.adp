...
<a name="install-tsearch2" id="install-tsearch2"></a>Install Tsearch2 module</h3></div></div></div><a class="indexterm" name="idp140444322296584" id="idp140444322296584"></a><p>If you want full text search, and you are running PostgreSQL,
