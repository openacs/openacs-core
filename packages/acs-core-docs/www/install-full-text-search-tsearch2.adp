...
<a name="install-tsearch2" id="install-tsearch2"></a>Install Tsearch2 module</h3></div></div></div><a class="indexterm" name="idp140255968147608" id="idp140255968147608"></a><p>If you want full text search, and you are running PostgreSQL,
