...
<a name="install-tsearch2" id="install-tsearch2"></a>Install Tsearch2 module</h3></div></div></div><a class="indexterm" name="idp140205661094696" id="idp140205661094696"></a><p>If you want full text search, and you are running PostgreSQL,
