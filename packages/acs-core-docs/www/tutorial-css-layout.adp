...
<a name="idp140697194135744" id="idp140697194135744"></a>.LRN home page with table-based
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140697194140752" id="idp140697194140752"></a>.LRN Home with CSS-based layout</h3></div></div></div><div class="mediaobject" align="center"><img src="images/dotlrn-style-3.png" align="middle"></div><p>A sample of the HTML code (<a class="ulink" href="files/dotlrn-style-2" target="_top">full source</a>)</p><pre class="programlisting">&lt;div class="left"&gt;
