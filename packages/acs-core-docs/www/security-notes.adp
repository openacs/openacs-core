...
<property name="context">{/doc/acs-core-docs {Documentation}} {Security Notes}</property>
...
performance reasons, as it is called by the request processor.</p><div class="cvstag">($Id: security-notes.xml,v 1.7 2014/10/27
