...
example "<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>" might
be the service name for the <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>.net
...
the <code class="computeroutput"><em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em></code> group
so that it can use database and server commands associated with
that group. (If you don&#39;t know how to do this, type
<strong class="userinput"><code>man usermod</code></strong>. You
can type <strong class="userinput"><code>groups</code></strong> to
find out which groups a user is a part of)</p><pre class="screen">
[root root]# <strong class="userinput"><code>useradd <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
</code></strong>
...
[root root]# <strong class="userinput"><code>usermod -g web <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
</code></strong>
</pre><p>FreeBSD creates the user this way:</p><pre class="screen">
[root root]# <strong class="userinput"><code>mkdir -p /home/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
</code></strong>
[root root]# <strong class="userinput"><code>pw useradd -n <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em> -g web -d /home/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em> -s /bin/bash</code></strong>
[root root]#
<span class="action">mkdir -p /home/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
pw useradd -n <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em> -g web -d /home/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em> -s /bin/bash
</span>
</pre>
</div><div class="sect2">
<div class="titlepage"><div><div><h3 class="title">
...
[root root]#
<span class="action">mkdir /var/lib/aolserver
chgrp web /var/lib/aolserver
chmod 770 /var/lib/aolserver</span>
</pre>
</div><div class="sect2">
<div class="titlepage"><div><div><h3 class="title">
...
[root root]# <strong class="userinput"><code>sh /home/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>/install/install.sh</code></strong>
...
<li class="listitem">
<p>Unpack the OpenACS tarball and rename it to <code class="computeroutput">$OPENACS_SERVICE_NAME</code>. Secure the directory
...
[$OPENACS_SERVICE_NAME aolserver]$ <strong class="userinput"><code>mv openacs-5.9.0 <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
</code></strong>
...
[$OPENACS_SERVICE_NAME aolserver]$ <strong class="userinput"><code>chown -R <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>.<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em><em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
</code></strong>
...
[$OPENACS_SERVICE_NAME ~]$ <strong class="userinput"><code>svrmgrl</code></strong>
SVRMGR&gt; <strong class="userinput"><code>connect internal;</code></strong>
SVRMGR&gt; <strong class="userinput"><code>create tablespace <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
      datafile '/ora8/m02/oradata/ora8/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>01.dbf' 
      size 50M 
      autoextend on 
      next 10M
      maxsize 300M
...
the tablespace and rights to connect. We&#39;ll use <code class="computeroutput"><em class="replaceable"><code>$OPENACS_SERVICE_NAMEpassword</code></em></code>
as our password.</p><p>Write down what you specify as <span class="emphasis"><em>service_name</em></span> (i.e. <code class="computeroutput"><em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em></code>) and
<span class="emphasis"><em>database_password</em></span> (i.e.
<code class="computeroutput"><em class="replaceable"><code>$OPENACS_SERVICE_NAMEpassword</code></em></code>).
You will need this information for configuring exports and
AOLserver.</p><pre class="programlisting">
SVRMGR&gt; <strong class="userinput"><code>create user <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em> identified by <em class="replaceable"><code>$OPENACS_SERVICE_NAMEpassword</code></em> default tablespace <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
    temporary tablespace temp quota unlimited on <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>;</code></strong>
SVRMGR&gt; <strong class="userinput"><code>grant connect, resource, ctxapp, javasyspriv, query rewrite to <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>;</code></strong>
SVRMGR&gt; <strong class="userinput"><code>revoke unlimited tablespace from <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>;</code></strong>
SVRMGR&gt; <strong class="userinput"><code>alter user <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em> quota unlimited on <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>;</code></strong>
SVRMGR&gt; <strong class="userinput"><code>exit;</code></strong>
...
/usr/local/pgsql/bin/createdb -E UNICODE <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
</span>
</pre>
</li><li class="listitem">
...
0 1-23 * * * /usr/local/pgsql/bin/vacuumdb --analyze <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
0 0 * * * /usr/local/pgsql/bin/vacuumdb --full --analyze <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
...
<a class="link" href="">Add Full Text Search Support</a>
(OPTIONAL)</p></li><li class="listitem"><p>At this point the database should be ready for installing
OpenACS.</p></li>
</ul></div>
</li>
</ul></div>
...
<li class="listitem">
<p>The AOLserver architecture lets you run an arbitrary number of
...
various dependent places. The Reference Platform uses <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>.</p></li><li class="listitem"><p>
...
<a class="link" href="">Enable OpenFTS Full Text Search</a>
...
<li class="listitem">
<p>Kill any current running AOLserver processes and start a new
one. The recommended way to start an AOLserver process is by
running the included script, <code class="computeroutput">/var/lib/aolserver/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>/etc/daemontools/run</code>.
...
<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
user via <code class="computeroutput">grep <em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
/etc/passwd</code> and then put those numbers into the command line
via <code class="computeroutput">-u <em class="replaceable"><code>501</code></em> -g <em class="replaceable"><code>502</code></em>
</code>. In AOLserver 4, you
must also send a <code class="computeroutput">-b</code> flag. Do
this by editing the <code class="computeroutput">run</code> file as
...
(<code class="computeroutput">/var/lib/aolserver/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>/log/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>-error.log</code>)
...
[$OPENACS_SERVICE_NAME $OPENACS_SERVICE_NAME]$ <strong class="userinput"><code>/usr/local/aolserver/bin/nsd-postgres -t /var/lib/aolserver/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>/config.tcl</code></strong>
</pre>
...
shutdown.</a>
</p></li><li class="listitem"><p>Install Full Text Search (OPTIONAL). If you have <a class="link" href="">installed OpenFTS</a> and enabled OpenFTS, you can now
<a class="link" href="">install</a> the OpenFTS Driver package and
Full Text Search Engine package in the OpenACS service.</p></li><li class="listitem"><p>This is a good time to make a <a class="link" href="snapshot-backup" title="Manual backup and recovery">backup</a> of your service. If this is
...
[$OPENACS_SERVICE_NAME $OPENACS_SERVICE_NAME]$ <strong class="userinput"><code>exit</code></strong>
logout
[root src]# <strong class="userinput"><code>su - <strong class="userinput"><code><em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em></code></strong>
</code></strong>
