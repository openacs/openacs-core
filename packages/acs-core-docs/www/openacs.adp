...
ANALYZE</code> every day.</p><a class="indexterm" name="id5566" id="id5566"></a><pre class="screen">[$OPENACS_SERVICE_NAME $OPENACS_SERVICE_NAME]$ <strong class="userinput"><code>export EDITOR=emacs;crontab -e</code></strong>
...
Open it in an editor to adjust the parameters.</p><a class="indexterm" name="id5592" id="id5592"></a><pre class="screen">[root root]# <strong class="userinput"><code>su - <span class="replaceable"><span class="replaceable">$OPENACS_SERVICE_NAME</span></span>
</code></strong>
