...
ANALYZE</code> every day.</p><a class="indexterm" name="idp140560462626232" id="idp140560462626232"></a><pre class="screen">
...
Open it in an editor to adjust the parameters.</p><a class="indexterm" name="idp140560462641784" id="idp140560462641784"></a><pre class="screen">[root root]# <strong class="userinput"><code>su - <span class="replaceable"><span class="replaceable">$OPENACS_SERVICE_NAME</span></span>
</code></strong>
