...
<a name="idp140302491006064" id="idp140302491006064"></a>Installing OpenACS packages</h3></div></div></div><p>An OpenACS package extends your website and lets it do things it
