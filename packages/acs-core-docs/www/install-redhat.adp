...
<a class="indexterm" name="idp140697732456080" id="idp140697732456080"></a> (Wherever you see the word secure, you
...
<p>Configure Networking. <a class="indexterm" name="idp140697732480192" id="idp140697732480192"></a> Again, if you
...
<a class="indexterm" name="idp140697732497952" id="idp140697732497952"></a>Select any additional languages you want
...
(this installs emacs<a class="indexterm" name="idp140697732505680" id="idp140697732505680"></a>),</td></tr><tr><td>click <code class="computeroutput"><span class="guilabel"><span class="guilabel">Details</span></span></code> next
...
Publishing</span></span></code> (<a class="indexterm" name="idp140697732512496" id="idp140697732512496"></a>this installs
...
(required for the <a class="indexterm" name="idp140697732531104" id="idp140697732531104"></a>photo-album packages,</td></tr><tr><td>uncheck<code class="computeroutput"><span class="guilabel"><span class="guilabel">isdn4k-utils</span></span></code>
...
<li class="listitem">
<p>
<a class="indexterm" name="idp140697732248528" id="idp140697732248528"></a> SSH is the protocol we use to connect
