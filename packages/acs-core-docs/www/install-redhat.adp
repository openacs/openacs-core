...
<property name="context">{/doc/acs-core-docs {Documentation}} {Appendix A. Install Red Hat
8/9}</property>
...
of these packages installed independently.)</p><p>The installation guide assumes you have:</p><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc;">
...
the network until we're sure the computer is secure. <a class="indexterm" name="idp140302500590496" id="idp140302500590496"></a>
...
the install. Choose <code class="computeroutput"><span class="guilabel"><span class="guilabel">Server</span></span></code> and
...
<p>Reformat the hard drive. If you know what you're doing, do this
...
to its liking.</p><div class="orderedlist"><ol class="orderedlist" type="a">
...
<u><span class="accel">N</span></u>ext</span></span></code>
</p></li><li class="listitem"><p>On the pop-up window asking "Are you sure you want to do this?"
click <code class="computeroutput"><span class="guibutton"><span class="guibutton">
...
<p>Configure Networking. <a class="indexterm" name="idp140302500617120" id="idp140302500617120"></a> Again, if you
...
Click <code class="computeroutput"><span class="guibutton"><span class="guibutton">Edit</span></span></code>,
...
are secure. Choose <code class="computeroutput"><span class="guilabel"><span class="guilabel">Hi<u><span class="accel">g</span></u>h</span></span></code> security level. Check
...
<a class="indexterm" name="idp140302500042608" id="idp140302500042608"></a>Select any additional languages you want
...
<p>On the Package selection page, we're going to uncheck a lot of
...
(this installs emacs<a class="indexterm" name="idp140302500050848" id="idp140302500050848"></a>),</td></tr><tr><td>click <code class="computeroutput"><span class="guilabel"><span class="guilabel">Details</span></span></code> next
...
Publishing</span></span></code> (<a class="indexterm" name="idp140302500058160" id="idp140302500058160"></a>this installs
...
all the packages in one big list, so select <code class="computeroutput"><span class="guilabel"><span class="guilabel">
...
(required for the <a class="indexterm" name="idp140302500078208" id="idp140302500078208"></a>photo-album packages,</td></tr><tr><td>uncheck<code class="computeroutput"><span class="guilabel"><span class="guilabel">isdn4k-utils</span></span></code>
...
later),</td></tr><tr><td>check <code class="computeroutput"><span class="guilabel"><span class="guilabel">tcl</span></span></code> (we need
...
</li><li class="listitem"><p>Red Hat isn't completely happy with the combination of packages
we've selected, and wants to satisfy some dependencies. Don't let
it. On the next screen, choose <code class="computeroutput"><span class="guilabel"><span class="guilabel">I<u><span class="accel">g</span></u>nore Package
...
useful than it used to be, and we won't bother. Select <code class="computeroutput"><span class="guilabel"><span class="guilabel">No,I
<u><span class="accel">d</span></u>o not want to create a boot
disk</span></span></code> and click <code class="computeroutput"><span class="guibutton"><span class="guibutton">
...
<li class="listitem">
<p>
<a class="indexterm" name="idp140302500117152" id="idp140302500117152"></a> SSH is the protocol we use to connect
...
<p>Red Hat still installed a few services we don't need, and which
...
leaving PostgreSQL the way it is.)</p><pre class="screen">
...
the kernel; you should also check for other critical packages.</p><p>Upgrade the kernel to fix a security hole. The default Red Hat
