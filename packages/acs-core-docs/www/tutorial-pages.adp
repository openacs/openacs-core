...
<a name="idp140302490312672" id="idp140302490312672"></a>Install some API</h3></div></div></div><p>As a workaround for missing content-repository functionality,
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140302491631488" id="idp140302491631488"></a>Page Map</h3></div></div></div><p>Our package will have two visible pages. The first shows a list
...
<a name="idp140302491632848" id="idp140302491632848"></a><p class="title"><b>Figure 9.5. Page
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140302491722464" id="idp140302491722464"></a>Build the "Index" page</h3></div></div></div><p>Each user-visible page in your package has, typically, three
