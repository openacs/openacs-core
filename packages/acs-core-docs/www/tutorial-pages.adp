...
<a name="idp140507672619736" id="idp140507672619736"></a>Install some API</h3></div></div></div><p>As a workaround for missing content-repository functionality,
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140507673723048" id="idp140507673723048"></a>Page Map</h3></div></div></div><p>Our package will have two visible pages. The first shows a list
...
<a name="idp140507678720152" id="idp140507678720152"></a><p class="title"><strong>Figure 9.5. Page
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140507672603272" id="idp140507672603272"></a>Build the "Index" page</h3></div></div></div><p>Each user-visible page in your package has, typically, three
