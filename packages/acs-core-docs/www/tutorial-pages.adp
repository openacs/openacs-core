...
<a name="idp140444318587880" id="idp140444318587880"></a>Install some API</h3></div></div></div><p>As a workaround for missing content-repository functionality,
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140444318591720" id="idp140444318591720"></a>Page Map</h3></div></div></div><p>Our package will have two visible pages. The first shows a list
...
<a name="idp140444318593080" id="idp140444318593080"></a><p class="title"><strong>Figure 9.5. Page
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140444318595704" id="idp140444318595704"></a>Build the "Index" page</h3></div></div></div><p>Each user-visible page in your package has, typically, three
