...
<a name="idp140480057386368" id="idp140480057386368"></a>Install some API</h3></div></div></div><p>As a workaround for missing content-repository functionality,
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140480045362496" id="idp140480045362496"></a>Page Map</h3></div></div></div><p>Our package will have two visible pages. The first shows a list
...
<a name="idp140480058438800" id="idp140480058438800"></a><p class="title"><b>Figure 9.5. Page
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140480045270512" id="idp140480045270512"></a>Build the "Index" page</h3></div></div></div><p>Each user-visible page in your package has, typically, three
