...
<a name="idp140667816348168" id="idp140667816348168"></a>Install some API</h3></div></div></div><p>As a workaround for missing content-repository functionality,
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140667814089512" id="idp140667814089512"></a>Page Map</h3></div></div></div><p>Our package will have two visible pages. The first shows a list
...
<a name="idp140667814090872" id="idp140667814090872"></a><p class="title"><strong>Figure 9.5. Page
...
<div class="titlepage"><div><div><h3 class="title">
<a name="idp140667814093304" id="idp140667814093304"></a>Build the "Index" page</h3></div></div></div><p>Each user-visible page in your package has, typically, three
