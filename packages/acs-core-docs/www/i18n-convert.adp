...
<p><strong>Internationalize Date and Time queries. </strong></p><div class="orderedlist"><ol class="orderedlist" type="a">
<li class="listitem">
...
<strong>Internationalize Numbers. </strong> To
...
<strong>Internationalizing Forms. </strong>When coding forms,
...
<a name="idp140598138445200" id="idp140598138445200"></a>Avoiding common i18n mistakes</h3></div></div></div><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc;">
<li class="listitem">
<p>
...
<p>
<strong>Quoting in the message catalog for tcl. </strong>Watch
...
<p>
<strong>Be careful with curly brackets. </strong>Code within
