...
/packages/acs-bootstrap-installer/bootstrap.tcl</p></li></ul></div><p>This document describes the startup (bootstrapping) process for
...
<div class="titlepage"><div><div><h3 class="title">
<a name="bootstrap-acs-startup-process" id="bootstrap-acs-startup-process"></a>The Startup Process</h3></div></div></div><p>When <code class="computeroutput">nsd</code> is started, it
reads its configuration file and <code class="computeroutput">chroot</code>s itself if necessary. It then loads
...
details).</p><p>Next AOLserver sources, in lexicographical order, each file in
