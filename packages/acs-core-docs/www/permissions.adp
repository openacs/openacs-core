...
<property name="context">{/doc/acs-core-docs {Documentation}} {Groups, Context, Permissions}</property>
...
application pages.</p><div class="cvstag">($Id: permissions.xml,v 1.17 2010/12/11
