...
<property name="context">{/doc/acs-core-docs {Documentation}} {Subsites Requirements}</property>
...
to a particular package instance. The <a class="link" href="rp-design" title="Request Processor Design">request
...
<li class="listitem"><p>Package programmers (referred to as 'the programmer') must
develop subcommunity-aware applications.</p></li><li class="listitem"><p>Site administrators (referred to as 'the administrator') use
...
configuration parameters to the current subsite.</p><p>Jane Admin maintains www.company.com. She learns of Joe's work
...
<div class="titlepage"><div><div><h3 class="title">
<a name="subsites-requirements-api" id="subsites-requirements-api"></a>Requirements: Programmer's API</h3></div></div></div><p>A subsite API is required for programmers to ensure their
