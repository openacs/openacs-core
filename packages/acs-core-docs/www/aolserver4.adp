...
<a name="aolserver4" id="aolserver4"></a>Install AOLserver 4</h2></div></div></div><div class="authorblurb">
<p>by <a class="ulink" href="mailto:sussdorff\@sussdorff.de" target="_top">Malte Sussdorff</a>
</p>
...
next step. In that step, replace <code class="computeroutput">--with-tcl=/usr/local/lib/</code> with
...
cvs -z3 -d:pserver:anonymous\@cvs.sourceforge.net:/cvsroot/tcllib co -r tcllib-1-8 tcllib</span></span>
</pre>
</li><li class="listitem">
...
AOLserver</a>.</p></li>
</ol></div><div class="cvstag">($Id: aolserver4.html,v 1.27.2.1 2015/09/23
11:54:20 gustafn Exp $)</div>
</div>
