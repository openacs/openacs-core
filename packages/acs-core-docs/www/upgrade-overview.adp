...
to 4.5, upgrading will require manual effort.</p><p>If all of these conditions are true:</p><div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc;">
...
<li class="listitem"><p>Browse to the <a class="ulink" href="/acs-admin/install/" target="_top">Installer</a>.</p></li><li class="listitem"><p>Click install or upgrade under "Install from OpenACS Repository"
and select the packages to install or upgrade.</p></li><li class="listitem"><p>The APM will download the requested packages from OpenACS.org,
...
<a name="idp140722834542016" id="idp140722834542016"></a><p class="title"><b>Figure 5.1. Upgrading
with the APM</b></p><div class="figure-contents"><div class="mediaobject" align="center"><img src="images/upgrade-apm.png" align="middle" alt="Upgrading with the APM"></div></div>
...
<a name="idp140722829949328" id="idp140722829949328"></a><p class="title"><b>Table 5.1. Assumptions
in this section</b></p><div class="table-contents"><table class="table" summary="Assumptions in this section" cellspacing="0" border="1">
<colgroup>
<col><col>
</colgroup><tbody>
<tr>
