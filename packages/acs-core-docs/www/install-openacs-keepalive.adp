...
the startup shell script provided, <code class="computeroutput">/var/lib/aolserver/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>/etc/daemontools/run</code>.
...
location is <code class="computeroutput">/var/lib/aolserver/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>etc/daemontools/run</code>.</p><p>Daemontools creates additional files and directories to track
status and log. A daemontools directory is included in the OpenACS
tarball at <code class="computeroutput">/var/lib/aolserver/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>/etc/daemontools</code>.
...
<li class="listitem"><p>
<code class="computeroutput">svc -d /service/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
</code> -
Bring the server down</p></li><li class="listitem"><p>
<code class="computeroutput">svc -u /service/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
</code> -
Start the server up and leave it in keepalive mode.</p></li><li class="listitem"><p>
<code class="computeroutput">svc -o /service/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
</code> -
Start the server up once. Do not restart it if it stops.</p></li><li class="listitem"><p>
<code class="computeroutput">svc -t /service/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
</code> - Stop
and immediately restart the server.</p></li><li class="listitem"><p>
<code class="computeroutput">svc -k /service/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
</code> -
...
so it should still bounce back up immediately.</p></li>
</ul></div>
</li><li class="listitem">
...
<td align="center">aolserver</td><td align="center">supervise (a child of svscanboot)</td><td align="center">/service/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>/run</td><td align="center">/var/lib/aolserver/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>/log/error.log</td><td align="center">/var/lib/aolserver/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>/log/$OPENACS_SERVICE_NAME.log</td><td align="center">svc -k /service/<em class="replaceable"><code>$OPENACS_SERVICE_NAME</code></em>
</td>
</tr><tr>
