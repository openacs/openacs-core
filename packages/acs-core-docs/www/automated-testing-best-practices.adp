...
<strong>Quoting issues. </strong>Put some html in plain text
...
<strong>Whitespace input. </strong>Check that whitespace is
...
<strong>Doubleclick. </strong> Make sure that if you submit a
