...
<a name="idp140183975386520" id="idp140183975386520"></a>Getting Started</h4></div></div></div><p>All OpenACS code is available anonymously. To get code
...
<div class="titlepage"><div><div><h4 class="title">
<a name="idp140183975083672" id="idp140183975083672"></a>Checkout for Package Development</h4></div></div></div><p>If you are actively developing a non-core package, you should
...
<div class="titlepage"><div><div><h4 class="title">
<a name="idp140183975659032" id="idp140183975659032"></a>Checkout for Core Development</h4></div></div></div><p>If you are actively developing packages in the OpenACS Core,
...
<div class="titlepage"><div><div><h4 class="title">
<a name="idp140183975802216" id="idp140183975802216"></a>Checkout .LRN</h4></div></div></div><p>.LRN consists of a given version OpenACS core, plus a set of
...
<div class="titlepage"><div><div><h4 class="title">
<a name="idp140183975478200" id="idp140183975478200"></a>Modules</h4></div></div></div><p>All OpenACS code resides within a single CVS module,
...
<div class="titlepage"><div><div><h4 class="title">
<a name="idp140183976518600" id="idp140183976518600"></a> Tags and Branches</h4></div></div></div><p>Tags and Branches look similar in commands, but behave
...
<div class="titlepage"><div><div><h4 class="title">
<a name="idp140183976920648" id="idp140183976920648"></a> Informal Guidelines</h4></div></div></div><p>Informal guidelines which may be obsolete in places and should
