...
5.0.2:</p><pre class="screen"><span class="action">cd /var/lib/aolserver/$OPENACS_SERVICE_NAME
cvs2cl -F <em class="replaceable"><code>oacs-5-0</code></em> --delta <em class="replaceable"><code>openacs-5-0-0-final</code></em>:<em class="replaceable"><code>oacs-5-0</code></em> -f ChangeLog
...
cd /var/lib/aolserver/$OPENACS_SERVICE_NAME/packages
       ./acs-core-docs/www/files/update-info <em class="replaceable"><code>5.2.1</code></em><em class="replaceable"><code>2006-01-16</code></em>
</pre>
...
operations much faster).</p><pre class="screen"><span class="action">cd /var/tmp
cvs -d /cvsroot checkout -r <em class="replaceable"><code>oacs-5-0</code></em> acs-core</span></pre><p>If doing .LRN, repeat with the dotlrn cvs tree.</p><pre class="screen"><span class="action">cd /var/tmp
mkdir dotlrn-packages
cd dotlrn-packages
cvs -d /dotlrn-cvsroot checkout -r <em class="replaceable"><code>dotlrn-2-0</code></em> dotlrn-all
</span></pre>
</li><li class="listitem">
<p>Tag the tree. If it&#39;s a final release of core, move or
create the appropriate openacs-major-minor-compat tag. (Ie, if
releasing 5.0.3 final, move the openacs-5-0-compat flag.)</p><pre class="screen"><span class="action">cd /var/tmp/openacs-4
cvs tag -F <em class="replaceable"><code>openacs-5-0-0a1</code></em>
cvs tag -F <em class="replaceable"><code>openacs-5-0-compat</code></em>
</span></pre><div class="tip" style="margin-left: 0.5in; margin-right: 0.5in;">
...
login) so that you don&#39;t have to log in for each module.</p><pre class="screen"><span class="action">cd /var/tmp/dotlrn-packages
for dir in *; do ( cd $dir &amp;&amp; cvs tag <em class="replaceable"><code>dotlrn-2-0-2-final</code></em> ); done
for dir in *; do ( cd $dir &amp;&amp; cvs tag -F <em class="replaceable"><code>openacs-5-0-compat</code></em> ); done
</span></pre><p>Note that for the compat tag we use the <span class="action">-F</span> flag which will force the tag to the new version
(just in case someone has created the tag already on another
version). Exercise care when doing this since you don&#39;t want to
inadvertently move a prior release tag. Also if the tagging goes
horribly wrong for some reason you can delete the tag via
<span class="command"><strong>cvs tag -d
...
done on openacs.org:</p><pre class="screen"><span class="action">cd /var/tmp
cvs -d /cvsroot checkout -r <em class="replaceable"><code>openacs-5-1-compat</code></em> openacs-4
cd openacs-4
cvs tag <em class="replaceable"><code>openacs-5-1-2-final</code></em>
</span></pre>
</li>
</ol></div>
</li><li class="listitem">
...
cd /var/tmp/tarball
cvs -d /cvsroot export -r <em class="replaceable"><code>openacs-5-0-0a1</code></em> acs-core</span></pre>
</li><li class="listitem">
<p>Generate the tarball.</p><pre class="screen"><span class="action">cd /var/tmp/tarball
mv openacs-4 openacs-<em class="replaceable"><code>5.0.0a1</code></em>
tar cz -f <em class="replaceable"><code>openacs-5.0.0a1.tar.gz</code></em> openacs-<em class="replaceable"><code>5.0.0a1</code></em>
</span></pre>
</li>
</ol></div>
</li><li class="listitem">
...
things from openacs-4 to OpenACS at the end)</p><pre class="screen"><span class="action">mkdir /var/tmp/dotlrn-tarball
cd /var/tmp/dotlrn-tarball
cvs -d /cvsroot export -r <em class="replaceable"><code>openacs-5-0-0a1</code></em> acs-core
cd /var/tmp/dotlrn-tarball/openacs-4/packages
cvs -d /cvsroot export -r <em class="replaceable"><code>openacs-5-0-0a1</code></em> dotlrn-prereq
cvs -d /dotlrn-cvsroot export -r <em class="replaceable"><code>dotlrn-2-0-0a1</code></em> dotlrn-core
</span></pre>
</li><li class="listitem">
<p>Copy the dotlrn install.xml file, which controls which packages
are installed on setup, to the root location:</p><pre class="screen"><span class="action">cp /var/tmp/dotlrn-tarball/openacs-4/packages/dotlrn/install.xml \
   /var/tmp/dotlrn-tarball/openacs-4
</span></pre>
</li><li class="listitem">
<p>Generate the tarball</p><pre class="screen"><span class="action">cd /var/tmp/dotlrn-tarball
mv openacs-4 dotlrn-<em class="replaceable"><code>2.0.0a1</code></em>
tar cz -f <em class="replaceable"><code>dotlrn-2.0.0a1.tar.gz</code></em> dotlrn-<em class="replaceable"><code>2.0.0a1</code></em>
</span></pre>
</li>
</ol></div>
</li>
