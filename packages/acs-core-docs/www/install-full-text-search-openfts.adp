...
<a name="install-openfts" id="install-openfts"></a>Install OpenFTS module</h3></div></div></div><a class="indexterm" name="idp140387971598984" id="idp140387971598984"></a><p>If you want full text search, and you are running PostgreSQL,
...
PostgreSQL instance</h3></div></div></div><a class="indexterm" name="idp140387896361864" id="idp140387896361864"></a><p>If you are installing Full Text Search, add required packages to
