...
<a name="install-openfts" id="install-openfts"></a>Install OpenFTS module</h3></div></div></div><a class="indexterm" name="idp140205661179704" id="idp140205661179704"></a><p>If you want full text search, and you are running PostgreSQL,
...
PostgreSQL instance</h3></div></div></div><a class="indexterm" name="idp140205661209032" id="idp140205661209032"></a><p>If you are installing Full Text Search, add required packages to
