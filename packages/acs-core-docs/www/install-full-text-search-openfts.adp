...
<a name="install-openfts" id="install-openfts"></a>Install OpenFTS module</h3></div></div></div><a class="indexterm" name="idp140507644090504" id="idp140507644090504"></a><p>If you want full text search, and you are running PostgreSQL,
...
PostgreSQL instance</h3></div></div></div><a class="indexterm" name="idp140507676626664" id="idp140507676626664"></a><p>If you are installing Full Text Search, add required packages to
