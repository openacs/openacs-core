...
<a name="install-openfts" id="install-openfts"></a>Install OpenFTS module</h3></div></div></div><a class="indexterm" name="idp140255972262072" id="idp140255972262072"></a><p>If you want full text search, and you are running PostgreSQL,
...
PostgreSQL instance</h3></div></div></div><a class="indexterm" name="idp140255972773272" id="idp140255972773272"></a><p>If you are installing Full Text Search, add required packages to
