...
<a name="install-openfts" id="install-openfts"></a>Install OpenFTS module</h3></div></div></div><a class="indexterm" name="idp140673145942704" id="idp140673145942704"></a><p>If you want full text search, and you are running PostgreSQL,
...
PostgreSQL instance</h3></div></div></div><a class="indexterm" name="idp140673146905040" id="idp140673146905040"></a><p>If you are installing Full Text Search, add required packages to
