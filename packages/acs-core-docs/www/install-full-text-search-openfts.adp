...
<a name="install-openfts" id="install-openfts"></a>Install OpenFTS module</h3></div></div></div><a class="indexterm" name="idp140302511686976" id="idp140302511686976"></a><p>If you want full text search, and you are running PostgreSQL,
...
PostgreSQL instance</h3></div></div></div><a class="indexterm" name="idp140302508160560" id="idp140302508160560"></a><p>If you are installing Full Text Search, add required packages to
