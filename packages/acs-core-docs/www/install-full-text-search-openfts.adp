...
<a name="install-openfts" id="install-openfts"></a>Install OpenFTS module</h3></div></div></div><a class="indexterm" name="idp140688950448104" id="idp140688950448104"></a><p>If you want full text search, and you are running PostgreSQL,
...
PostgreSQL instance</h3></div></div></div><a class="indexterm" name="idp140688950475208" id="idp140688950475208"></a><p>If you are installing Full Text Search, add required packages to
