...
<a name="install-openfts" id="install-openfts"></a>Install OpenFTS module</h3></div></div></div><a class="indexterm" name="idp140722780862592" id="idp140722780862592"></a><p>If you want full text search, and you are running PostgreSQL,
...
PostgreSQL instance</h3></div></div></div><a class="indexterm" name="idp140722780676512" id="idp140722780676512"></a><p>If you are installing Full Text Search, add required packages to
