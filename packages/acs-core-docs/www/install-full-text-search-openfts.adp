...
<a name="install-openfts" id="install-openfts"></a>Install OpenFTS module</h3></div></div></div><a class="indexterm" name="idp140667803197048" id="idp140667803197048"></a><p>If you want full text search, and you are running PostgreSQL,
...
PostgreSQL instance</h3></div></div></div><a class="indexterm" name="idp140667811906056" id="idp140667811906056"></a><p>If you are installing Full Text Search, add required packages to
