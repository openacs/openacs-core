...
<a name="install-openfts" id="install-openfts"></a>Install OpenFTS module</h3></div></div></div><a class="indexterm" name="idp140434645517032" id="idp140434645517032"></a><p>If you want full text search, and you are running PostgreSQL,
...
PostgreSQL instance</h3></div></div></div><a class="indexterm" name="idp140434645544136" id="idp140434645544136"></a><p>If you are installing Full Text Search, add required packages to
