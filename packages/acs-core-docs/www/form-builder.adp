...
<a name="idp140219187221056" id="idp140219187221056"></a>SELECT elements</h4></div></div></div><div class="orderedlist"><ol class="orderedlist" type="1"><li class="listitem">
<p>
...
<div class="titlepage"><div><div><h4 class="title">
<a name="idp140218653817728" id="idp140218653817728"></a>Error when selecting values</h4></div></div></div><p>This generally happens when there is an error in your query.</p>
</div>
</div>
</div>
