...
<a name="idp140722825253744" id="idp140722825253744"></a>SELECT elements</h4></div></div></div><div class="orderedlist"><ol class="orderedlist" type="1"><li class="listitem">
<p>
...
<div class="titlepage"><div><div><h4 class="title">
<a name="idp140722831800784" id="idp140722831800784"></a>Error when selecting values</h4></div></div></div><p>This generally happens when there is an error in your query.</p>
</div>
</div>
</div>
