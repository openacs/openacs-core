...
<p><a name="type" id="type"><strong>10.0 Content Types</strong></a></p>
...
<blockquote>
<p>
<strong>10.10</strong> Content types must be associated with unique
keyword identifiers, such as <tt>press_release</tt>, so they can be
referenced in data tables, queries and procedural code.</p><p>
<strong>10.20</strong> Content types must be associated with singular and
plural descriptive labels, such as <strong>Press Release</strong> and
<strong>Press Releases</strong>, to simplify user recognition.</p><p>
<strong>10.20</strong> Content types may specify any number of
<em>attributes</em>. Attribute values are simple strings or
numbers.</p><p>
<strong>10.30</strong> Content types may inherit attributes from any other
...
<strong>10.40</strong> Part of the definition of a content type may
include a description of the parent-child relationships allowed for
items of this type. For example, a <strong>Press Release</strong> may contain
one or more items of type <strong>Image</strong>, but it should not contain
any items of type <strong>Internal Financial Status Report</strong>.</p><p>
<strong>10.60</strong> A content type definition may include a list of
allowed file MIME types for items of this type.</p><p>
<strong>10.70</strong> A content type definition may include a list of
...
manual may include the tokens <strong>next</strong>, <strong>previous</strong> and
<strong>see_also</strong>. Each type of relationship may include a minimum
and/or maximum number of relationships of this type that are
required for an item to be published.</p>
</blockquote>
<p><a name="item" id="item"><strong>20.0 Content Items</strong></a></p>
...
<blockquote>
<p>
<strong>20.10</strong> Content items must have a simple unique identifier
so they can be related to other objects in the system.</p><p>
<strong>20.20</strong> Each content item consists of a set of attributes
and a single text or binary object.</p><p>
<strong>20.25</strong> All content items are associated with a few basic
...
<strong>20.30</strong> Each content item must be an instance of a
...
<strong>20.40</strong> A content item must have a unique, persistent URL
...
Organization</a>).</p><p>
<strong>20.50</strong> It must be possible to specify the language of each
item.</p><p>
<strong>20.60</strong> It must be possible to maintain a revision history
...
<strong>20.80</strong>. A content item may be associated with any number
of workflows.</p><p>
<strong>20.90</strong>. Content items may themselves be "containers" or
"parents" for other content items. For example, an <strong>Article</strong>
may contain multiple <strong>Sections</strong>.</p><p>
<strong>20.95</strong> Each item may be associated with any number of
...
<blockquote>
<p>
<strong>30.10</strong>. A revision consists of the complete state of the
...
attributes.</p><p>
<strong>30.20</strong>. The data model must be extensible so that
revisions for all content types (with any number of attributes) may
be stored and retrieved efficiently.</p>
</blockquote>
<p><a name="organization" id="organization"><strong>40.0 Organization of
the Repository</strong></a></p>
<blockquote>
<p>
<strong>40.10</strong>. The data model must support the hierarchical
organization of content items in a manner similar to a file
system.</p><p>
<strong>40.20</strong>. The URL of a content item should reflect its
...
<p>
<strong>40.20.5.10</strong>. A URL-encoded name for building the path to
folders and individual items within the folder.</p><p>
<strong>40.20.5.20</strong>. A pointer to a content item that may serve as
the "index" for the folder (i.e. the item that is served when the
URL of the folder itself is accessed).</p><p>
<strong>40.20.5.30</strong>. A set of constraints on the number and type
of content items that may be stored in the folder.</p>
</blockquote><p>
<strong>40.30</strong>. It must be possible to create symbolic links or
...
<strong>40.30.5.10</strong>. A URL-encoded
...
<strong>100.10.20</strong>. Set the description of a MIME type</p><p>
<strong>100.10.30</strong>. Get the description of a MIME type</p><p>
<strong>100.10.40</strong>. Determine whether a MIME type is text or
binary</p><p>
<strong>100.10.50</strong>. Get a list of registered MIME types</p><p>
...
<blockquote>
<p>
<strong>100.20.10</strong>. Register a locale, including language,
territory and character set.</p><p>
<strong>100.20.20</strong>. Get the language of a specified locale.</p><p>
<strong>100.20.10</strong>. Get the character set code of a specified
locale using either Oracle or WETF/ISO/ANSI codes.</p><p>
<strong>100.20.30</strong>. Get the number, date and currency format of a
specified locale.</p><p>
<strong>100.20.40</strong>. Convert a text content item to a specified
locale (character set).</p><p>
<strong>100.20.50</strong>. Get a list of registered locales.</p><p>
<strong>100.20.60</strong>. Unregister a locale.</p>
</blockquote>
<p><strong>100.30 Content Types</strong></p>
<blockquote>
<p>
<strong>100.30.10</strong>. Create a content type, optionally specifying
that it inherits the attributes of another content type. Multiple
inheritance is not supported.</p><p>
<strong>100.30.20</strong>. Get and set the singular and plural proper
names for a content type.</p><p>
<strong>100.30.30</strong>. Create an attribute for a content type.</p><p>
<strong>100.30.40</strong>. Register a content type as a container for
another content type, optionally specifying a minimum and maximum
count of live items.</p><p>
<strong>100.30.50</strong>. Register a content type as a container for
another content type, optionally specifying a minimum and maximum
count of live items.</p><p>
<strong>100.30.60</strong>. Register a set of tags or tokens for labeling
child items of an item of a particular content type.</p><p>
<strong>100.30.70</strong>. Register a <a href="#template">template</a>
for use with a content type, optionally specifying a use context
("intranet", "extranet") which the template is appropriate to
use.</p><p>
<strong>100.30.80</strong>. Register a particular type of workflow to
associate with items of this content type by default.</p><p>
<strong>100.30.90</strong>. Register a MIME type as valid for a content
type. For example, the <strong>Image</strong> content type may only allow GIF
and JPEG file formats.</p><p>
<strong>100.30.95</strong> Register a relationship with another type of
...
<blockquote>
<p>
<strong>100.40.10</strong>. Create a new item, specifying a parent context
or the root of the repository by default.</p><p>
<strong>100.40.15</strong>. Rename an item.</p><p>
<strong>100.40.17</strong>. Copy an item to another location in the
repository.</p><p>
<strong>100.40.20</strong>. Move an item to another location in the
repository.</p><p>
<strong>100.40.30</strong>. Get the full path (ancestry of an item) up to
the root.</p><p>
<strong>100.40.35</strong>. Get the parent of an item.</p><p>
<strong>100.40.40</strong>. Determine whether an item may have a child of
a particular content type, based on the existing children of the
item and the constraints on the content type.</p><p>
<strong>100.40.45</strong>. Label a child item with a tag or token, based
...
<strong>100.40.55</strong>. Get the children of an item by type or
tag.</p><p>
<strong>100.40.60</strong>. Establish a generic relationship between any
object and a content item, optionally specifying a relationship
type.</p><p>
<strong>100.40.70</strong>. Create a revision.</p><p>
<strong>100.40.80</strong>. Mark a particular revision of an item as
"live".</p><p>
<strong>100.40.83</strong>. Specify a start and end time when an item
should be available.</p><p>
<strong>100.40.85</strong>. Clear the live revision attribute of an item,
effectively removing it from public view.</p><p>
<strong>100.40.90</strong>. Get a list of revisions for an item, including
modifying user, date modified and comments.</p><p>
<strong>100.40.95</strong>. Revert to an older revision (create a new
...
<blockquote>
<p>
<strong>100.50.10</strong>. Create a <strong>folder</strong> for logical groups of
...
<strong>100.50.20</strong>. Set a label and description for a folder.</p><p>
<strong>100.50.30</strong>. Get the label and description for a
folder.</p><p>
<strong>100.50.40</strong>. Get a list of folders contained within a
folder.</p><p>
<strong>100.50.50</strong>. Move a folder to another folder.</p><p>
<strong>100.50.60</strong>. Copy a folder to another folder.</p><p>
<strong>100.50.70</strong>. Create a <strong>symbolic link</strong> to a folder from
...
<strong>100.50.80</strong>. Tag all live item revisions within a folder
...
site. Folder objects themselves are <strong>not</strong> eligible for
...
<strong>100.60.20</strong>. Create a new subject category as the child of
another subject category.</p><p>
<strong>100.60.30</strong>. Assign a subject category to a content
item.</p><p>
<strong>100.60.40</strong>. Remove a subject category from an item.</p><p>
<strong>100.60.50</strong>. Get the subject categories assigned to a
content item.</p>
</blockquote>
<h3>Search</h3>
