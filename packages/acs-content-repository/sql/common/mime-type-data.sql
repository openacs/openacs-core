...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Comma separated value'   , 'application/csv'               , 'csv' );
...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'IGES graphics format'    , 'application/iges'              , 'iges' );
...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Rich Text Format'        , 'application/rtf'               , 'rtf' );
...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'GNU Tar'                 , 'application/x-gtar'            , 'gtar');
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Compressed - gzip'       , 'application/x-gzip'            , 'gz' );
...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Mac Stuffit compressed'  , 'application/x-stuffit'         , 'sit' );
...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Tar Archive'             , 'application/x-tar'             , 'tar' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'TeX source'              , 'application/x-tex'             , 'tex' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Texinfo (emacs)'         , 'application/x-texinfo'         , 'texinfo' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'troff'                   , 'application/x-troff'           , 'tr' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'troff with MAN macros'   , 'application/x-troff-man'       , 'man' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'troff with ME macros'    , 'application/x-troff-me'        , 'me' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'troff with MS macros'    , 'application/x-troff-ms'        , 'ms' );
...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Audio MPEG'              , 'audio/x-mpeg'                  , 'mpga');
...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'mpeg url (m3u)'          , 'audio/x-mpegurl'               , 'm3u');
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Windows Media Services (wma)', 'audio/x-ms-wma'            , 'wma');
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Windows Media Services (wmv)', 'audio/x-ms-wmv'            , 'wmv');
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Realaudio'               , 'audio/x-pn-realaudio'          , 'ra' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Realaudio Plugin'        , 'audio/x-pn-realaudio-plugin'   , 'rm' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Microsoft WAVE audio'    , 'audio/x-wav'                   , 'wav' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Brookhaven PDB'          , 'chemical/x-pdb'                , 'pdb');
insert into cr_mime_types (label,mime_type,file_extension) values ( 'XMol XYZ'                , 'chemical/x-xyz'                , 'xyz');
...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Fractal Image Format'    , 'image/fif'                     , 'fif');
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Image - Gif'             , 'image/gif'                     , 'gif' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Image Exchange Format'   , 'image/ief'                     , 'ief' );
...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'WAP wireless bitmap'     , 'image/vnd.wap.wbmp'            , 'wbmp');
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Image - CMU Raster'      , 'image/x-cmu-raster'            , 'ras' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Flexible Image Transport', 'image/x-fits'                  , 'fit' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Macromedia Freehand'     , 'image/x-freehand'              , 'fh' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'SVG'                     , 'image/xml+svg'                 , 'svg' );
...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'X bitmap'                , 'image/x-xbitmap'               , 'xbm' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'X pixmap'                , 'image/x-xpixmap'               , 'xpm' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'X window dump (xwd)'     , 'image/x-xwindowdump'           , 'xwd' );
...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'SGML Text'               , 'text/sgml'                     , 'sgml');
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Cascading style sheet'   , 'text/css'                      , 'css' );
...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Text (flowed)'           , 'text/plain; format=flowed'     , 'text' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Enriched Text'           , 'text/enriched'                 , 'rtx' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Tab separated values'    , 'text/tab-separated-values'     , 'tsv' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'WMLScript'               , 'text/vnd.wap.wmlscript'        , 'wmls');
insert into cr_mime_types (label,mime_type,file_extension) values ( 'WML'                     , 'text/vnd.wap.wml'              , 'wml');
insert into cr_mime_types (label,mime_type,file_extension) values ( 'XML Document'            , 'text/xml'                      , 'xml' );
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Structured enhanced text', 'text/x-setext'                 , 'etx');
insert into cr_mime_types (label,mime_type,file_extension) values ( 'XSL style sheet'         , 'text/xsl'                      , 'xsl' );
...
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Windows Media Services (wm)', 'video/x-ms-wm'              , 'wm');
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Windows Media Services (wvx)', 'video/x-ms-wvx'            , 'wvx');
insert into cr_mime_types (label,mime_type,file_extension) values ( 'Windows Media Services (wmx)', 'video/x-mx-wmx'            , 'wmx');
