...
create function rel_segment_test_check (integer, integer, integer)
returns boolean as '
declare
  test_check__segment_id            alias for $1;
  test_check__party_id              alias for $2;
  test_check__container_id          alias for $3;
  v_pass_p                          boolean;
  str                               text;
begin
...
create function test_segs() returns integer as '
declare
  A      integer;
  B      integer;
  C      integer;
...
create function check_segs() returns integer as '
declare
  A      integer;
  B      integer;
  C      integer;
