...
<ul>
<li><em>System/Package "coversheet" - where all documentation for
this software is linked off of</em></li><li><em>Design document</em></li><li><em>Developer's guide</em></li><li><em>User's guide</em></li><li>
...
<strong>10.10</strong> Provide a consistent representation and API for
creating and referencing a locale</p><p>
<strong>10.20</strong> There will be a Tcl library of locale-aware
formatting and parsing functions for numbers, dates and times.
<em>Note that Java has builtin support for these already</em>.</p><p>
<strong>10.30</strong> For each locale there will be default date, number
...
<blockquote>
<p>
<strong>20.10</strong> The locale for a request should be computed by the
...
<p>
<strong>20.20</strong> An API will be provided for getting the current
...
<blockquote>
<p>
<strong>40.10</strong> Each message will referenced via unique a key.</p><p>
<strong>40.20</strong> The key for a message will have some hierarchical
structure to it, so that sets of messages can be grouped with
respect to a module name or package path.</p><p>
<strong>40.30</strong> The API for lookup of a message will take a locale
and message key as arguments, and return the appropriate
translation of that message for the specifed locale.</p><p>
<strong>40.40</strong> The API for lookup of a message will accept an
...
message catalog.</p><p>
<strong>40.50</strong> For use within templates, custom tags which invoke
the message lookup API will be provided.</p><p>
<strong>40.60</strong> Provide a method for importing and exporting a flat
...
<strong>40.70</strong> Since translations may be in different character
...
needing update.</p><p>
<strong>40.90</strong> The message lookup must be as efficient as possible
...
<p>
<strong>50.0</strong> A locale will have a primary associated character
...
editing them in their favorite editor.</em></font>
</p>
...
<p><font color="#080EFF"><em>The simplest design is probably just to
...
<strong>50.10</strong> Tcl library files can be authored in any character
set. The system must have a way to determine the character set
before loading the files, probably from the filename.</p><p>
<strong>50.20</strong> Tcl page script files can be authored in any
character set. The system must have a way to determine the
character set before loading the files, probably from the
filename.</p><h4>Submitted Form Data Character Set</h4><strong>50.30</strong> Data which is submitted with a HTTP request using a
...
Unicode on demand.
<p>
<strong>50.35</strong> The developer must be able to override the default
system choice of character set when parsing and validating user
form data.</p><p>
<strong>50.30.10</strong> Extra hair: In Japan and some other Asian
...
in an unexpected alternate encoding.</p><h4>Output Character Set</h4><strong>50.40</strong> The output character set for a page request will be
determined by default by the locale associated with the request
(see requirement 20.0).
<p>
<strong>50.50</strong> It must be possible for a developer to manually
override the output character set encoding for a request using an
API function.</p>
</blockquote>
<h3>VI.F ACS Kernel Issues</h3>
<blockquote>
<strong>60.10</strong> All ACS error messages must use the
message catalog and the request locale to generate error message
for the appropriate locale.
<p>
<strong>60.20</strong> Web server error messages such as 404, 500, etc
must also be delivered in the appropriate locale.</p><p>
<strong>60.30</strong> Where files are written or read from disk, their
...
<blockquote>
<strong>70.0</strong> For a given abstract URL, the designer may
create multiple locale-specific template files may be created (one
per locale or language)
<p>
<strong>70.10</strong> For a given page request, the system must be able
...
locale.</p><p>
<strong>70.30</strong> A template file may be created in any character
set. The system must have a way to know which character set a
template file contains, so it can properly process it.</p><h4>Formatting Datasource Output in Templates</h4><strong>70.50</strong> The properties of a datasource column may include a
...
as dates or numbers.
<p>
<strong>70.70</strong> For forms which allow users to upload files, a
standard method for a user to indicate the charset of a text file
being uploaded must be provided.</p><p><font color="#080EFF"><em>Design note: this presumably applies to
uploading data to the content repository as well</em></font></p>
</blockquote>
<h3>VI.H Sorting and Searching</h3>
<blockquote>
<strong>80.10</strong> Support API for correct collation (sorting
order) on lists of strings in locale-dependent way.
<p>
<strong>80.20</strong> For the Tcl API, we will say that locale-dependent
...
<strong>80.40</strong> The system must handle full-text search in any
supported language.</p>
</blockquote>
<h3>VI.G Time Zones</h3>
<blockquote>
<strong>90.10</strong> Provide API support for specifying a time
zone
<p>
<strong>90.20</strong> Provide an API for computing time and date
...
<strong>90.30</strong> Store all dates and times in universal time zone,
UTC.</p><p>
<strong>90.40</strong> For a registered users, a time zone preference
should be stored.</p><p>
<strong>90.50</strong> For a non-registered user a time zone preference
should be attached via a session or else UTC should be used to
display every date and time.</p><p>
<strong>90.60</strong> The default if we can't determine a time zone is to
display all dates and times in some universal time zone such as
GMT.</p>
</blockquote>
<h3>VI.H Database</h3>
<blockquote><p>
<strong>100.10</strong> Since UTF8 strings can use up to three (UCS2) or
...
<blockquote>
<p>
<strong>110.10</strong> The email message sending API will allow for a
character set encoding to be specified.</p><p>
<strong>110.20</strong> The email accepting API will allow for character
