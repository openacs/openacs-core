    ...
    default_message {
        ...
        display_template {
            <if @messages.deleted_p;literal@ true>
              <span style="color: red; font-style: italic;">DELETED</span> (@messages.default_message;noi18n@)
            </if>
            <else>
              @messages.default_message;noi18n@
            </else>
        }
    }
}
        ...
        translated_message {
            ...
            display_template {
                <if @messages.translation_deleted_p;literal@ true>
                  <span style="color: red; font-style: italic;">DELETED</span> (@messages.translated_message;noi18n@)
                </if>
                <else>
                  <if @messages.translated_message@ not nil>@messages.translated_message;noi18n@</if>
