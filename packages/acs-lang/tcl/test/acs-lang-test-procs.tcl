...
aa_register_case util__replace_temporary_tags_with_lookups {
    ...
    aa_run_with_teardown \
        ...
        # We need to force the API to use the test catalog file
        ...
        #error "catalog_array=[array get catalog_array] updated_messages_array=[array get updated_messages_array]"
