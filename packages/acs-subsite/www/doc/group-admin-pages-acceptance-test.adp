...
the default relationship types</font></li><li><font>Add a new group called "Foobar" - Make sure Foobar
appears after adding the group</font></li><li><font>Click on Foobar</font></li><li><font>Click on nuke this group then click no. Ensure group is
...
anything).</font></li><li><font>Define another group type, child of group, named
...
</li><li><font>Click on "Add a permissible relationship type." Ensure
that you are not given a select bar but are offered a link to
"create a new relationship type"</font></li><li><font>Create a group of type test.</font></li><li><font>Delete the test group type (first verify that the cancel
button works)</font></li><li><font>Go to the "project" group type</font></li><li><font>Add a required attribute called "Project type" of
datatype enumeration. Values are "Client" "Toolkit"</font></li><li><font>Add an optional attribute "Monthly fee" of type integer
and default of "10000"</font></li><li><font>Add a third attribute called test.</font></li><li><font>Make sure you can see all the attributes. Delete the test
attribute</font></li><li>
<font>Go to "/admin/object-types/one?object_type=project" and
ensure that start_date and monthly fees are listed as attributes.
Also make sure:</font><ul>
...
</li><li><font>Go to "/admin/object-types/one?object_type=subproject"
and ensure the new attributes of project are in the pl/sql
package</font></li><li><font>Now go back to the group type admin page for the
"Projects" group type. Remove the composition relation. Make sure
...
(integer, not required)</font></li><li><font>Delete the employment relationship type.</font></li><li><font>Re-add the employment relationship type (we're testing to
make sure the age attribute is correctly removed and flushed from
the cache)</font></li><li><font>Click on membership relation, then click on create
...
system.</font></li><li><font>Make sure you see the segment "Main Site Members" for
parties with a membership relation to the main site.</font></li><li><font>Go to the ArsDigita group.</font></li><li><font>Add guidestar.org as a component</font></li><li><font>Remove the membership relation type from this
group</font></li><li><font>Add the employment relation type</font></li><li><font>Create a segment named "ArsDigita employees"</font></li><li><font>Add a constraint named "ArsDigita employees must be Main
Site Members" for employees and the segment "Main Site
Members"</font></li><li><font>Go back to the guidestar.org group</font></li><li><font>Add yourself as a project lead.</font></li><li><font>Click on the project lead segment "GuideStar Project
...
segment</font></li><li><font>Add a constraint named "Project leads must be employees"
that says all "project leaders must be employees of
ArsDigita"</font></li><li><font>Make sure you see yourself as a violation. Remove the
...
that there "There is no other Person that can be added as Project
Leader to GuideStar.Org"</font></li><li><font>Add yourself as an arsdigita employee</font></li><li><font>Make yourself the project lead on
guidestar.org</font></li><li><font>Go back to /admin/groups and select "relationship typ
site." Remove your membership relation. You should get prompted to
...
delete the project group type.</font></li><li><font>Delete the ArsDigita group.</font></li><li><font>Go to /admin/rel-types/</font></li><li><font>Click on "View all roles"</font></li><li><font>Click on "Project Leader" - delete this role</font></li><li><font>Click on "Employer" then on Employment
