  ...
  <ul>
   <if @packages_normal:rowcount@ ne 0>
    <multiple name="packages_normal">
     <li>@packages_normal.name@ [<a href="@packages_normal.instance_delete_url@" onclick="return confirm('Are you sure you want to delete package @packages_normal.name@');">delete</a>]</li>
    </multiple>
   </if>
   <else>
  ...
  <ul>
   <if @packages_singleton:rowcount@ ne 0>
    <multiple name="packages_singleton">
     <li>@packages_singleton.name@ [<a href="@packages_singleton.instance_delete_url@" onclick="return confirm('Are you sure you want to delete package @packages_singleton.name@');">delete</a>]</li>
    </multiple>
   </if>
   <else>
