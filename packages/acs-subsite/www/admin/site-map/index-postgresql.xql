...
<rdbms><type>postgresql</type><version>7.1</version></rdbms>
  ...
  <fullquery name="dbqd.acs-subsite.www.admin.site-map.index.path_select">
    <querytext>
  ...
  <fullquery name="dbqd.acs-subsite.www.admin.site-map.index.node_id">
    <querytext>
...
from apm_packages p right outer join (
 ...
 on site_map.object_id = p.package_id
  ...
  <fullquery name="dbqd.acs-subsite.www.admin.site-map.index.package_types">
    <querytext>
