...
ad_proc twt::dotlrn::setup_terms { server_url } {
    ...
    dotlrn::add_term $server_url "Fall" "September" "2003" "January" "2004"    
    dotlrn::add_term $server_url "Spring" "January" "2004" "July" "2004"
    dotlrn::add_term $server_url "Fall" "September" "2004" "January" "2005"    
}
...
ad_proc twt::dotlrn::setup_departments { server_url } {
    ...
    dotlrn::add_department $server_url "Mathematics" \
    ...
    dotlrn::add_department $server_url "Computer Science" \
    ...
    dotlrn::add_department $server_url "Architecture" \
    ...
    dotlrn::add_department $server_url "Business Administration" \
